...
- **Preview files**: markdown renders with the shell's own Markdown engine, images and SVG show inline, PDFs open sandboxed — office documents open in your external apps from the tree's right-click menu.
