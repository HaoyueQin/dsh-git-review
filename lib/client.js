window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function DiffPane({ file, diff, truncated, loading, binary, size, full, onToggleFull, scope, onScopeChange, view, onViewChange, search, t }) {
		...
		async function loadStatus(cwd) {
			const payload = await hostCall("status", { cwd });
		...
		async function loadFileDiff(cwd, path, origPath, untracked, full, scope) {
		...
		function ReviewView({ cwd, t }) {
			...
			(0, react.useEffect)(() => {
				...
				(selectedFile.unchanged === true || effectiveView === "file" ? loadFileContent(cwd, selected) : loadFileDiff(cwd, selected, selectedFile.origPath, selectedFile.untracked, diffFull, diffScope)).then((next) => {
				...
				children: [(0, react_jsx_runtime.jsxs)("header", {
					...
					children: [
						(0, react_jsx_runtime.jsxs)("span", {
							...
							title: t("branch"),
							children: [(0, react_jsx_runtime.jsx)(BranchIcon, {}), data?.branch ?? "—"]
						}),
