window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var review_module_css_default = {
			...
			"fileRowFocus": "review-module_fileRowFocus",
			...
			"graphResizeHandle": "review-module_graphResizeHandle",
			...
			"imageClip": "review-module_imageClip",
			"imageCompareScroll": "review-module_imageCompareScroll",
			"imageEnd": "review-module_imageEnd",
			"imageEndBlank": "review-module_imageEndBlank",
			"imageEndCap": "review-module_imageEndCap",
			"imageEndImg": "review-module_imageEndImg",
			"imageEndLabel": "review-module_imageEndLabel",
			"imageEndSize": "review-module_imageEndSize",
			"imageFrame": "review-module_imageFrame",
			"imageHint": "review-module_imageHint",
			"imageLayer": "review-module_imageLayer",
			"imageLayerBlend": "review-module_imageLayerBlend",
			"imageLayerFixed": "review-module_imageLayerFixed",
			"imageLayerOnion": "review-module_imageLayerOnion",
			"imageOverlayWrap": "review-module_imageOverlayWrap",
			"imagePairRow": "review-module_imagePairRow",
			"imagePairStack": "review-module_imagePairStack",
			"imageSlider": "review-module_imageSlider",
			"imageSliderRow": "review-module_imageSliderRow",
			"imageSwipeBar": "review-module_imageSwipeBar",
			"imageToolRow": "review-module_imageToolRow",
			...
			"pluginPanelBody": "review-module_pluginPanelBody",
			...
			"returnFab": "review-module_returnFab",
			...
			"scriptBanner": "review-module_scriptBanner",
			"scriptBannerText": "review-module_scriptBannerText",
		...
		function FileMenu({ state, apps, writable, refsMode, allowFsOps, useInput, inputActions, onClose, openApp, copyPath, copyName, rename, remove, gitAction, conflictResolve, openInPlugin, t }) {
			...
			if (mode === "delete") return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					(0, react_jsx_runtime.jsx)("div", {
						className: review_module_css_default.fileMenuTitle,
						children: t(isDir ? "menu.confirmDeleteDirTitle" : "menu.confirmDeleteTitle")
					}),
					(0, react_jsx_runtime.jsx)("div", {
			...
			if (mode === "discard") return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					(0, react_jsx_runtime.jsx)("div", {
						className: review_module_css_default.fileMenuTitle,
						children: t(isDir ? "menu.confirmDiscardDirTitle" : "menu.confirmDiscardTitle")
					}),
					(0, react_jsx_runtime.jsx)("div", {
						className: review_module_css_default.fileMenuDeletePath,
						children: state.path
			...
			if (mode === "apps") return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							apps === null && (0, react_jsx_runtime.jsx)("div", {
								className: review_module_css_default.pickerEmpty,
								children: t("menu.loadingApps")
							}),
							(apps ?? []).map((app) => (0, react_jsx_runtime.jsxs)("button", {
								type: "button",
			...
			const pluginOpener = state.from === "commit" && !isDir ? openInPlugin : void 0;
			const items = [
				...pluginOpener === void 0 ? [] : [{
					key: "open-in-plugin",
					icon: (0, react_jsx_runtime.jsx)(FileIcon, {}),
					label: t("menu.openInPlugin"),
					onClick: () => {
						pluginOpener(state.path);
						onClose();
					}
				}],
				{
				...
				children: [
					...
					(0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
						items.map((item) => (0, react_jsx_runtime.jsxs)("button", {
							type: "button",
							className: review_module_css_default.fileMenuItem + (item.disabled === true ? " " + review_module_css_default.pickerItemDisabled : ""),
						...
						(0, react_jsx_runtime.jsxs)("button", {
							...
							children: [(0, react_jsx_runtime.jsx)("span", {
								...
								className: review_module_css_default.pickerItemName,
								children: t(isDir ? "menu.copyDirName" : "menu.copyName")
							})]
						}),
						...
						writable && !refsMode && !isDir && state.git?.conflicted === true && conflictResolve !== void 0 && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
							(0, react_jsx_runtime.jsx)("div", { className: review_module_css_default.fileMenuDivider }),
							(0, react_jsx_runtime.jsxs)("button", {
								type: "button",
								className: review_module_css_default.fileMenuItem,
						...
						writable && fsOps && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
							(0, react_jsx_runtime.jsx)("div", { className: review_module_css_default.fileMenuDivider }),
							(0, react_jsx_runtime.jsxs)("button", {
								type: "button",
								className: review_module_css_default.fileMenuItem,
		...
		function CommitMenu({ state, running, onClose, run, t }) {
			const [mode, setMode] = (0, react.useState)("menu");
			const [note, setNote] = (0, react.useState)(null);
			const [busyWhat, setBusyWhat] = (0, react.useState)(null);
			const [hardArmed, setHardArmed] = (0, react.useState)(false);
			const rootRef = (0, react.useRef)(null);
			const [pos, setPos] = (0, react.useState)({
				left: state.x,
				top: state.y
			...
			const exec = async (action, graphMode) => {
				...
				setMode("busy");
				setNote(null);
				setBusyWhat(action + (graphMode !== void 0 ? " " + graphMode : ""));
			...
			if (mode === "reset") return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(0, react_jsx_runtime.jsx)("div", {
						className: review_module_css_default.fileMenuDeletePath,
						children: state.hash.slice(0, 7) + " · " + state.subject
					}),
					(0, react_jsx_runtime.jsxs)("div", {
						className: review_module_css_default.fileMenuApps,
						children: [
							...
							(0, react_jsx_runtime.jsxs)("button", {
								...
								onClick: () => {
									if (!hardArmed) {
										setHardArmed(true);
										setNote(t("history.resetHardArm"));
										return;
									}
									setHardArmed(false);
									exec("reset", "hard");
								...
								children: [(0, react_jsx_runtime.jsx)("span", {
									className: review_module_css_default.pickerItemName,
									children: hardArmed ? t("history.resetHardArm") : t("history.resetHard")
								}), (0, react_jsx_runtime.jsx)("span", {
									className: review_module_css_default.pickerItemMeta,
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					mode === "busy" && (0, react_jsx_runtime.jsx)("div", {
						className: review_module_css_default.commitNote,
						children: t("menu.busy") + (busyWhat !== null ? ": " + busyWhat : "")
					})
				]
			});
		}
		...
		function unquoteHeaderPath(field) {
		...
		async function hostCall(action, body) {
			...
			try {
				const res = await fetch("/dsh-git-review/api/" + encodeURIComponent(action), {
					method: "POST",
		...
		function fmtGraphDate(timestamp) {
			...
			return (date.getFullYear() === new Date().getFullYear() ? "" : date.getFullYear() + "/") + pad(date.getMonth() + 1) + "/" + pad(date.getDate()) + " " + pad(date.getHours()) + ":" + pad(date.getMinutes());
		}
		...
		function WorktreeRow({ width, label, selected, onSelect, columns, density }) {
			const mid = ROW_H / 2;
			const cx = LANE_W / 2;
			return (0, react_jsx_runtime.jsxs)("button", {
				type: "button",
				...
				children: [
					...
					density >= 1 && (0, react_jsx_runtime.jsx)("span", {
					...
					density >= 2 && (0, react_jsx_runtime.jsx)("span", { className: review_module_css_default.commitDate }),
					density >= 3 && (0, react_jsx_runtime.jsx)("span", { className: review_module_css_default.commitHash }),
					density >= 4 && (0, react_jsx_runtime.jsx)("span", { className: review_module_css_default.commitAuthor })
				]
			});
		}
		const GRAPH_DENSITY_COLUMNS = {
			0: "var(--graph-w)",
			1: "calc(var(--graph-w) + 6px) minmax(0, 1fr)",
			2: "calc(var(--graph-w) + 6px) minmax(0, 1fr) 86px",
			3: "calc(var(--graph-w) + 6px) minmax(0, 1fr) 86px 64px",
			4: "calc(var(--graph-w) + 6px) minmax(0, 1fr) 86px 64px minmax(76px, 110px)"
		};
		function CommitGraph({ commits, lanes, selected, onSelect, collapsed = false, density = 4, worktree, worktreeSelected = false, onSelectWorktree, onCommitMenu, t }) {
			...
			const showTip = (node, commit) => {
				...
				setTip({
					x: Math.max(8, Math.min(rect.right, window.innerWidth - 330)),
					y: Math.max(8, top),
					commit
				});
			};
			const listRef = (0, react.useRef)(null);
			const litColorRef = (0, react.useRef)(null);
			const litLine = (color) => {
			...
			if (collapsed) return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					worktree !== null && worktree !== void 0 && (0, react_jsx_runtime.jsx)("button", {
						type: "button",
					...
					commits.map((commit, index) => (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						...
						children: (0, react_jsx_runtime.jsx)(GraphCell, {
							row: lanes[index],
							width: graphWidth
						})
					}, commit.hash)),
				...
				children: [
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							density >= 1 && (0, react_jsx_runtime.jsx)("span", { children: t("graph.col.subject") }),
							density >= 2 && (0, react_jsx_runtime.jsx)("span", { children: t("graph.col.date") }),
							density >= 3 && (0, react_jsx_runtime.jsx)("span", { children: t("graph.col.commit") }),
							density >= 4 && (0, react_jsx_runtime.jsx)("span", { children: t("graph.col.author") })
						]
					}),
					...
					commits.map((commit, index) => (0, react_jsx_runtime.jsxs)("button", {
						...
						children: [
							...
							density >= 1 && (0, react_jsx_runtime.jsxs)("span", {
								className: review_module_css_default.commitMain,
		...
		function RefPicker({ value, headLabel, refs, commits, exclude, disabledHashes, headHash, placeholder, onPick, onOpen, t }) {
			...
			const hashByName = (0, react.useMemo)(() => {
				const map = new Map();
				for (const commit of commits ?? []) for (const deco of commit.refs ?? []) if (!map.has(deco.name)) map.set(deco.name, commit.hash);
				return map;
			}, [commits]);
			const hashDisabled = (hash) => hash !== void 0 && (disabledHashes?.has(hash) ?? false);
					...
					children: [(0, react_jsx_runtime.jsx)("div", {
						...
						children: [
							headLabel !== null && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)(GroupLabel, { children: t("ref.current") }), (0, react_jsx_runtime.jsx)(PickerItem, {
								selected: value === null,
								disabled: exclude === null || exclude === "HEAD" || hashDisabled(headHash ?? void 0),
								icon: (0, react_jsx_runtime.jsx)(BranchIcon, {}),
								name: headLabel,
								meta: "HEAD",
								onPick: () => {
							...
							q === "" && commits !== null && branches.length === 0 && remotes.length === 0 && tags.length === 0 && commitsMatch.length === 0 && (0, react_jsx_runtime.jsx)("div", {
								className: review_module_css_default.pickerEmpty,
								children: t("picker.emptyAll")
							})
						]
					})]
				})]
		...
		function parseUnifiedDiff(text) {
			...
			for (const line of lines) {
				...
				if (line.startsWith("\\")) {
					...
					} else if (lastCell !== null) lastCell.noNewline = true;
					continue;
				}
				if (line.startsWith("-")) {
					lastCell = {
		...
		function makeSearchEngine(spec) {
			...
			const lower = (text) => {
				...
				if (lowerCached.size < 2e3) lowerCached.set(text, value);
				return value;
			};
			return {
				parts: (text) => {
		...
		function countRenderableMatches(parsed, engine, unified) {
			...
			for (const hunk of parsed.hunks) {
				...
				budget -= rows.length;
				if (unified) {
					for (const line of unifyHunkRows(rows)) if (engine.test(line.text)) count += 1;
				} else for (const row of rows) if (rowHasMatch(row, engine)) count += 1;
			}
			return count;
		}
		const WORD_HIGHLIGHT_BUDGET = 2e6;
		const WORD_HIGHLIGHT_MIN_RATIO = .3;
		function sharedCharRatio(a, b) {
		...
		function tokenizeLine(line, lang) {
			...
			while (at < line.length) {
				...
				if (/[0-9]/.test(ch) && (at === 0 || !isWordChar(line[at - 1]))) {
					...
					if (afterZero === "x" || afterZero === "X" || afterZero === "o" || afterZero === "O" || afterZero === "b" || afterZero === "B") {
						end += 2;
		...
		function makeLineHighlighter(path, budget = 4e6) {
			...
			return { line(text) {
				...
				if (cache.size > 8e3) {
					const oldest = Array.from(cache.keys()).slice(0, 4e3);
		...
		//#endregion
		//#region src/client/marked-text.tsx
		...
		function matchRanges(text, engine) {
			const ranges = [];
			const parts = engine.parts(text);
			let at = 0;
			for (let i = 0; i < parts.length; i++) {
				const length = parts[i].length;
				if (i % 2 === 1) ranges.push([at, at + length]);
				at += length;
			}
			return ranges;
		}
		function renderMarkedText(text, engine, tokens) {
			if (tokens === null || tokens.length === 0) return searchParts(text, engine);
			const ranges = matchRanges(text, engine);
			const cut = (start, end, from) => {
				const nodes = [];
				let cursor = start;
				for (let i = from; i < ranges.length; i++) {
					...
					nodes.push((0, react_jsx_runtime.jsx)("mark", {
						className: review_module_css_default.matchMark,
						children: text.slice(left, right)
					}, left));
					cursor = right;
				}
		...
		//#endregion
		//#region src/client/file-counts.tsx
		...
		function highlightedLine(text, engine, tokens) {
			return renderMarkedText(text, engine, tokens);
		}
		...
		function FilePane({ file, search, content, truncated, binary, size, loading, canShowDiff, view, onViewChange, syntaxHighlight, blameOn, onToggleBlame, blameState, onBlameJump, focusLine, previewAvailable, onShowPreview, t }) {
			const scrollRef = (0, react.useRef)(null);
			(0, react.useEffect)(() => {
				if (focusLine === void 0 || focusLine === null || loading) return;
				...
				children: [
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							(0, react_jsx_runtime.jsx)(FileCounts, { file }),
					...
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							!loading && !binary && visible.map((line, index) => (0, react_jsx_runtime.jsxs)("div", {
								...
								className: review_module_css_default.fileRowGrid + (blameOn && blameState.kind === "ready" && blameState.lines !== null ? " " + review_module_css_default.fileRowGridBlame : "") + (focusLine === index + 1 ? " " + review_module_css_default.fileRowFocus : ""),
								children: [
									blameOn && blameState.kind === "ready" && blameState.lines !== null && (() => {
										...
										const jumpable = onBlameJump !== void 0 && !repeated && row.hash !== "" && !/^0+$/.test(row.hash);
										const label = repeated ? "" : author + " " + short;
										if (!jumpable) return (0, react_jsx_runtime.jsx)("span", {
		...
		//#endregion
		//#region src/client/image-diff-pane.tsx
		const MODE_LABEL = {
		...
		function ImageDiffPane({ before, after, mode, onModeChange, stacked, beforeLabel, afterLabel, t }) {
			const scrollRef = (0, react.useRef)(null);
			const frameRef = (0, react.useRef)(null);
			const dragging = (0, react.useRef)(false);
			const [availW, setAvailW] = (0, react.useState)(0);
			const [natural, setNatural] = (0, react.useState)({
				before: null,
				after: null
			});
			const [swipe, setSwipe] = (0, react.useState)(50);
			const [opacity, setOpacity] = (0, react.useState)(50);
			(0, react.useEffect)(() => {
				setNatural({
					before: null,
					after: null
			...
			const frame = (0, react.useMemo)(() => {
				...
				for (const naturalEnd of [natural.before, natural.after]) {
					...
					fits.push({
						w: Math.max(1, Math.round(naturalEnd.w * scale)),
						h: Math.max(1, Math.round(naturalEnd.h * scale))
					});
				}
				if (fits.length === 0) return null;
				return {
					w: Math.max(...fits.map((fit) => fit.w)),
					h: Math.max(...fits.map((fit) => fit.h))
				};
			}, [natural, availW]);
			const learn = (key, size) => {
				setNatural((current) => current[key]?.w === size.w && current[key]?.h === size.h ? current : {
					...current,
					[key]: size
				});
			};
			...
			const endFigure = (key, label, end) => {
				const notice = endNotice(end);
				const size = natural[key];
				return (0, react_jsx_runtime.jsxs)("figure", {
					className: review_module_css_default.imageEnd,
					children: [(0, react_jsx_runtime.jsxs)("figcaption", {
						className: review_module_css_default.imageEndCap,
						children: [(0, react_jsx_runtime.jsx)("span", {
							className: review_module_css_default.imageEndLabel,
							children: label
						}), size !== null && (0, react_jsx_runtime.jsx)("span", {
							className: review_module_css_default.imageEndSize,
							children: size.w + " × " + size.h
						})]
					}), notice !== null || end.dataUrl === null ? (0, react_jsx_runtime.jsx)("div", {
						className: review_module_css_default.imageEndBlank,
						children: notice
					}) : (0, react_jsx_runtime.jsx)("img", {
						className: review_module_css_default.imageEndImg,
						src: end.dataUrl,
						alt: label,
						onLoad: (event) => {
							learn(key, {
			...
			const endLoading = (end) => end.dataUrl === null && !end.missing && !end.truncated && !end.failed;
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				className: review_module_css_default.imageCompareScroll,
				ref: scrollRef,
				children: [
					(0, react_jsx_runtime.jsxs)("div", {
						className: review_module_css_default.imageToolRow,
						children: [(0, react_jsx_runtime.jsx)("span", {
							className: review_module_css_default.scopeSwitch,
							role: "group",
							"aria-label": t("image.mode.label"),
							children: MODES.map((candidate) => (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								...
								children: t(MODE_LABEL[candidate])
							}, candidate))
						}), (0, react_jsx_runtime.jsx)("span", {
							className: review_module_css_default.imageHint,
							children: mode === "swipe" ? t("image.swipeHint") : mode === "onion" ? t("image.onionHint") : mode === "difference" ? t("image.diffHint") : ""
						})]
					}),
					mode !== "side" && oneSided && (0, react_jsx_runtime.jsx)("div", {
						className: review_module_css_default.noticeRow,
						children: t("image.oneSide")
					}),
					overlay ? (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)("div", {
						className: review_module_css_default.imageOverlayWrap,
						children: (0, react_jsx_runtime.jsxs)("div", {
							className: review_module_css_default.imageFrame,
							ref: frameRef,
							style: {
								width: frame.w,
								height: frame.h
							...
							children: [
								(0, react_jsx_runtime.jsx)("img", {
									className: review_module_css_default.imageLayer,
									src: after.dataUrl,
									alt: afterLabel
								}),
								mode === "swipe" && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)("div", {
									className: review_module_css_default.imageClip,
									style: { width: swipe + "%" },
									children: (0, react_jsx_runtime.jsx)("img", {
										className: review_module_css_default.imageLayerFixed,
										style: {
											width: frame.w,
											height: frame.h
										},
									...
									className: review_module_css_default.imageSwipeBar,
									style: { left: swipe + "%" },
									role: "slider",
									tabIndex: 0,
									...
									onPointerMove: (event) => {
										if (dragging.current) swipeAt(event.clientX);
									},
									onPointerUp: (event) => {
								...
								mode === "onion" && (0, react_jsx_runtime.jsx)("img", {
									className: review_module_css_default.imageLayer + " " + review_module_css_default.imageLayerOnion,
									style: { opacity: opacity / 100 },
									src: before.dataUrl,
									alt: beforeLabel
								}),
								mode === "difference" && (0, react_jsx_runtime.jsx)("img", {
									className: review_module_css_default.imageLayer + " " + review_module_css_default.imageLayerBlend,
									src: before.dataUrl,
									alt: beforeLabel
								})
							]
						})
					}), mode === "onion" && (0, react_jsx_runtime.jsxs)("div", {
						className: review_module_css_default.imageSliderRow,
						children: [
							(0, react_jsx_runtime.jsx)("span", {
								className: review_module_css_default.imageEndLabel,
							...
							(0, react_jsx_runtime.jsx)("input", {
								className: review_module_css_default.imageSlider,
								type: "range",
								min: 0,
								max: 100,
								value: opacity,
						...
						className: stacked ? review_module_css_default.imagePairStack : review_module_css_default.imagePairRow,
						children: [endFigure("before", beforeLabel, before), endFigure("after", afterLabel, after)]
					}),
					(0, react_jsx_runtime.jsx)("div", { className: review_module_css_default.diffBottomReserve })
				]
			});
		...
		function DiffPane({ file, diff, truncated, loading, binary, size, full, onToggleFull, scope, onScopeChange, view, onViewChange, showViewSwitch = true, allowFileView = true, wsIgnore, onToggleWs, syntaxHighlight, search, baseActive, useInput, inputActions, onDraftAdd, hunkOps, onHunkOp, hunkBusy, hunkNotice, onFileHistory, historyLoading, image, t }) {
			const parsed = (0, react.useMemo)(() => parseUnifiedDiff(diff), [diff]);
			const showImage = image !== void 0 && image.view === "compare";
			...
			const matchRowCount = (0, react.useMemo)(() => countRenderableMatches(parsed, engine, unified), [
				parsed,
				engine,
				unified
			]);
				...
				children: [
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							(0, react_jsx_runtime.jsx)("span", { className: review_module_css_default.diffHeaderSpacer }),
							matchRowCount > 0 && !showImage && (0, react_jsx_runtime.jsxs)("span", {
							...
							image !== void 0 && (0, react_jsx_runtime.jsxs)("span", {
								className: review_module_css_default.scopeSwitch,
								role: "group",
								"aria-label": t("image.compare"),
								children: [(0, react_jsx_runtime.jsx)("button", {
									type: "button",
									className: review_module_css_default.scopeBtn + (image.view === "compare" ? " " + review_module_css_default.scopeBtnActive : ""),
									"aria-pressed": image.view === "compare",
									onClick: () => {
										image.onViewChange("compare");
									},
									children: t("image.compare")
								}), (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									className: review_module_css_default.scopeBtn + (image.view === "source" ? " " + review_module_css_default.scopeBtnActive : ""),
									"aria-pressed": image.view === "source",
									onClick: () => {
										image.onViewChange("source");
									},
							...
							!showImage && (0, react_jsx_runtime.jsx)("button", {
								type: "button",
							...
							!showImage && (0, react_jsx_runtime.jsxs)("button", {
								type: "button",
								className: review_module_css_default.toolBtn,
					...
					notice !== null && !showImage && (0, react_jsx_runtime.jsx)("div", {
						className: review_module_css_default.noticeRow,
						children: notice
					}),
					...
					showImage && image !== void 0 ? (0, react_jsx_runtime.jsx)(ImageDiffPane, {
						before: image.before,
						after: image.after,
						mode: image.mode,
				...
				out.push((0, react_jsx_runtime.jsxs)(react.Fragment, { children: [
					...
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [(0, react_jsx_runtime.jsx)("span", {
							...
							children: "@@ -" + hunk.oldStart + "," + hunk.oldCount + " +" + hunk.newStart + "," + hunk.newCount + " @@" + (hunk.section === "" ? "" : " " + hunk.section) + (hunk.damaged ? " · " + ui.t("diff.truncated") : "")
		...
		function needsScriptNotice(text) {
		...
		function PreviewPane({ file, kind, text, textLoading, textTruncated = false, dataUrl, bytesFailed, bytesTruncated, onShowSource, onOpenExternal, t }) {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					scriptDeps && (0, react_jsx_runtime.jsxs)("div", {
						className: review_module_css_default.scriptBanner,
						role: "note",
						children: [(0, react_jsx_runtime.jsx)("span", {
							className: review_module_css_default.scriptBannerText,
							children: t("preview.scriptNotice")
						}), onOpenExternal !== void 0 && (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							className: review_module_css_default.toolBtn,
							onClick: onOpenExternal,
							children: t("preview.scriptOpen")
						})]
					}),
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							kind === "html" && (textLoading ? (0, react_jsx_runtime.jsx)("div", {
								className: review_module_css_default.paneNotice,
								children: t("file.loading")
							}) : (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)("iframe", {
								className: review_module_css_default.previewPdf,
								srcDoc: text,
								sandbox: "",
								title: file.path
		...
		//#endregion
		//#region src/client/image-sides.ts
		function existsInHead(x, untracked) {
			if (untracked) return false;
			if (x === void 0) return true;
			return x !== "A" && x !== "?";
		}
		function existsInIndex(x, untracked) {
			if (untracked) return false;
			if (x === void 0) return true;
			return x !== "D" && x !== "?";
		}
		function existsInWorktree(y, untracked) {
		...
		function resolveImageSides(input) {
			const untracked = input.untracked === true;
			const beforePath = input.origPath === void 0 || input.origPath === "" ? input.path : input.origPath;
			if (input.mode !== "worktree") {
				...
				return {
					before,
					after,
					comparable: before.side.kind !== "empty" && after.side.kind !== "empty"
				};
			}
		...
		function safeLinkText(text, href) {
		...
		function htmlFallbackForPreview(text) {
			return text.replace(/^[ \t]*<picture[^>]*>[ \t]*$/gim, "").replace(/^[ \t]*<\/picture>[ \t]*$/gim, "").replace(/^[ \t]*<source[^>]*\/?>[ \t]*$/gim, "").replace(/<picture[^>]*>/gi, "").replace(/<\/picture>/gi, "").replace(/<source[^>]*\/?>/gi, "").replace(/^[ \t]*<img\b[^>]*\/?>/gim, (tag) => {
				...
				return src === "" ? "" : "![" + (attr(tag, "alt") ?? "") + "](" + src + ")";
			}).replace(/^[ \t]*<a\b[^>]*href\s*=\s*(?:"([^"]*)"|'([^']*)')[^>]*>([\s\S]*?)<\/a>/gim, (_whole, dbl, sqt, text) => safeLinkText(text, dbl ?? sqt ?? "")).replace(/<a\b[^>]*href\s*=\s*(?:"([^"]*)"|'([^']*)')[^>]*>([\s\S]*?)<\/a>/gi, (_whole, dbl, sqt, text) => safeLinkText(text, dbl ?? sqt ?? "")).replace(/<\/?p\b[^>]*>/gi, "\n\n");
		}
		...
		function defangRemoteImages(text) {
			INLINE_IMG.lastIndex = 0;
			const inline = text.replace(INLINE_IMG, (whole, alt, url, _title) => /^https?:\/\//i.test(url) ? "[" + (alt === "" ? url : alt) + "](" + url + " \"external image\")" : whole);
			REF_DEF.lastIndex = 0;
			...
			REF_USE.lastIndex = 0;
			return inline.replace(REF_USE, (whole, alt, id) => {
				const ref = id === "" ? alt : id;
		...
		//#endregion
		//#region src/client/range-guard.ts
		function findBranchTip(commits, branch) {
			if (branch === null || branch === void 0 || branch === "") return null;
			for (const commit of commits) if (commit.refs !== void 0 && commit.refs.some((deco) => deco.name === branch)) return commit.hash;
			return null;
		}
		function resolveRangeHash(value, commits, headHash) {
			if (value === null || value === void 0) return null;
			if (value === "HEAD") return headHash;
			if (OBJECT_ID_RE.test(value.toLowerCase())) return value.toLowerCase();
			for (const commit of commits) if (commit.refs !== void 0 && commit.refs.some((deco) => deco.name === value)) return commit.hash;
			return null;
		}
		function isAncestorOrSelf(parents, ancestor, descendant, budget = 2e3) {
			if (ancestor === descendant) return true;
			const seen = new Set([descendant]);
			let frontier = [descendant];
			while (frontier.length > 0 && budget > 0) {
				const next = [];
				for (const hash of frontier) for (const parent of parents.get(hash) ?? []) {
		...
		function computeGraphLanes(commits) {
			...
			for (const commit of commits) {
				...
				rows.push({
					...
					outEdges,
					pass,
					laneCount: Math.max(live, lane + 1)
				});
			}
			return rows;
		}
		//#endregion
		//#region src/natural-order.ts
		...
		function flattenTree(children, collapsed) {
			const rows = [];
		...
		function createViewedStore(cwd, storage = typeof localStorage === "undefined" ? void 0 : localStorage) {
			const key = cwd === void 0 ? VIEWED_KEY : viewedKey(cwd);
			let order;
			try {
		...
		function FileRow({ entry, depth, selected, onSelect, matchCount, viewedHas, onToggleViewed, onFileMenu, t }) {
			...
			return (0, react_jsx_runtime.jsxs)("button", {
				...
				children: [
					...
					(0, react_jsx_runtime.jsx)(FileCounts, { file: entry.file }),
		...
		function DirRow({ dir, depth, collapsed, onToggleDir, onDirMenu }) {
			...
			return (0, react_jsx_runtime.jsxs)("button", {
				...
				onClick: () => {
					onToggleDir(dir.path);
				},
				onContextMenu: onDirMenu === void 0 || dir.path === "" ? void 0 : (event) => {
					event.preventDefault();
					event.stopPropagation();
					onDirMenu(dir.path, event.clientX, event.clientY, collectDirFiles(dir));
				},
				title: dir.path === "" ? void 0 : dir.path,
				children: [
		...
		function TreePanel({ files, selected, onSelect, filter, onFilterChange, collapsed, onToggleDir, mode, onModeChange, width, showModeRow = true, showFilter = true, listFailed, matchCounts, viewedHas, onToggleViewed, pendingCount, onFileMenu, onDirMenu, t }) {
			const visible = (0, react.useMemo)(() => filterFiles(files, filter), [files, filter]);
			const flat = filter.trim() !== "";
			const tree = (0, react.useMemo)(() => flat ? null : buildFileTree(visible), [flat, visible]);
			const treeRows = (0, react.useMemo)(() => tree === null ? [] : flattenTree(tree.children, collapsed), [tree, collapsed]);
			const [shown, setShown] = (0, react.useState)(TREE_PAGE);
			(0, react.useEffect)(() => {
				setShown(TREE_PAGE);
			}, [filter, files]);
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(0, react_jsx_runtime.jsx)("div", {
						...
						children: visible.length === 0 ? (0, react_jsx_runtime.jsx)("div", {
						...
						}) : flat ? (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [visible.slice(0, shown).map((file) => (0, react_jsx_runtime.jsx)(FileRow, {
							entry: {
								kind: "file",
								name: file.path,
								path: file.path,
							...
							onFileMenu,
							t
						}, file.path)), visible.length > shown && (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							className: review_module_css_default.scopeBtn,
							onClick: () => {
								setShown((value) => value + TREE_PAGE);
							},
							children: t("tree.showMore", { count: visible.length - shown })
						})] }) : (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [treeRows.slice(0, shown).map((row) => row.entry.kind === "file" ? (0, react_jsx_runtime.jsx)(FileRow, {
							entry: row.entry,
							depth: row.depth,
							selected,
							onSelect,
							...
							onFileMenu,
							t
						}, "f:" + row.entry.path) : (0, react_jsx_runtime.jsx)(DirRow, {
							dir: row.entry,
							depth: row.depth,
							collapsed,
							onToggleDir,
							onDirMenu
						}, "d:" + row.entry.path)), treeRows.length > shown && (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							className: review_module_css_default.scopeBtn,
							onClick: () => {
								setShown((value) => value + TREE_PAGE);
							},
							children: t("tree.showMore", { count: treeRows.length - shown })
						})] })
					})
				]
			});
		...
		async function loadStatus(cwd, base, target, wsIgnore) {
			...
			if (!payload.ok) return payload.isRepository === false ? {
				kind: "notRepo",
				root: payload.cwdRoot ?? cwd
			} : {
				kind: "error",
		...
		async function loadImageSide(cwd, target) {
			const empty = {
				kind: "ready",
				mime: "",
				base64: "",
			...
			const payload = target.side.kind === "index" ? await hostCall("file-bytes", {
				cwd,
				path: target.path,
				stage: "index"
			}) : target.side.kind === "ref" ? await hostCall("file-bytes", {
				cwd,
				path: target.path,
				ref: target.side.ref
			}) : await hostCall("file-bytes", {
				cwd,
				path: target.path
			});
			if (payload === null) return {
		...
		function imageEndState(state) {
			if (state.kind === "ready" && !state.missing && !state.truncated && state.mime.startsWith("image/") && state.kind === "ready") return {
				dataUrl: "data:" + state.mime + ";base64," + state.base64,
				missing: false,
				truncated: false,
				failed: false
			};
			return {
				...
				failed: state.kind === "failed" || state.kind === "ready" && !state.missing && !state.truncated && !state.mime.startsWith("image/")
			};
		}
		...
		const NO_PANEL_SELECTED = { activePanelId: null };
		const ALWAYS_VISIBLE_PANEL = ((selector) => selector === void 0 ? NO_PANEL_SELECTED : selector(NO_PANEL_SELECTED));
		function fmtCount(value) {
			return value.toLocaleString("en-US");
		}
		function ReviewView({ cwd: injectedCwd, sessionId, sessionsList, settings, t, useSession, useInput, inputActions, usePanelInfo }) {
			const cwd = (0, react.useSyncExternalStore)((0, react.useCallback)((notify) => sessionsList.subscribe(notify), [sessionsList]), () => sessionsList.getSnapshot().byId[sessionId]?.cwd ?? injectedCwd);
			const running = useSession !== void 0 ? useSession((s) => s.running) ?? false : false;
			const panelVisible = (usePanelInfo ?? ALWAYS_VISIBLE_PANEL)((info) => info.activePanelId) === null;
			...
			const [commitTreeWidth, setCommitTreeWidth] = (0, react.useState)(() => {
				try {
			...
			const commitTreeResizeRef = (0, react.useRef)(null);
			const startCommitTreeResize = (0, react.useCallback)((event) => {
				event.preventDefault();
				commitTreeResizeRef.current = {
					startX: event.clientX,
					startWidth: commitTreeWidth ?? 260
				};
				let raf = 0;
				let latest = 0;
				const onMove = (move) => {
				...
				const onUp = (move) => {
					...
					try {
						localStorage.setItem("dsh-git-review.commitTreeWidth", String(final));
					} catch {}
				};
				dragCleanupRef.current?.();
			...
			const onCommitTreeResizeKey = (0, react.useCallback)((event) => {
				if (event.key !== "ArrowLeft" && event.key !== "ArrowRight") return;
				event.preventDefault();
				...
				try {
					localStorage.setItem("dsh-git-review.commitTreeWidth", String(next));
				} catch {}
			}, [commitTreeWidth]);
			...
			const onTreeResizeKey = (0, react.useCallback)((event) => {
				if (event.key !== "ArrowLeft" && event.key !== "ArrowRight") return;
				event.preventDefault();
				const step = event.shiftKey ? 100 : 20;
				...
				setTreeWidth(next);
				try {
					localStorage.setItem("dsh-git-review.treeWidth", String(next));
				} catch {}
			}, [treeWidth]);
			...
			const [imageMode, setImageMode] = (0, react.useState)("side");
			const [imageSource, setImageSource] = (0, react.useState)(false);
			const [beforeBytes, setBeforeBytes] = (0, react.useState)({ kind: "idle" });
			const [afterBytes, setAfterBytes] = (0, react.useState)({ kind: "idle" });
			...
			const [pickerFeedWanted, setPickerFeedWanted] = (0, react.useState)(false);
			const wantPickerFeed = (0, react.useCallback)(() => {
				setPickerFeedWanted(true);
			}, []);
			...
			const [graphListWidth, setGraphListWidth] = (0, react.useState)(() => {
				try {
			...
			const [fitWidth, setFitWidth] = (0, react.useState)(null);
			const [fitTick, setFitTick] = (0, react.useState)(0);
			const graphListRef = (0, react.useRef)(null);
			const graphResizeRef = (0, react.useRef)(null);
			...
			const startGraphResize = (0, react.useCallback)((event) => {
				event.preventDefault();
				const section = graphListRef.current;
				const startWidth = graphListCollapsed ? section?.getBoundingClientRect().width ?? GRAPH_WIDTH_MIN : graphListWidth ?? section?.getBoundingClientRect().width ?? 480;
				graphResizeRef.current = {
					startX: event.clientX,
					startWidth
				};
				const clamp = (value) => Math.min(GRAPH_WIDTH_MAX, Math.max(GRAPH_WIDTH_MIN, value));
				let raf = 0;
				let latest = 0;
				...
				const onUp = (up) => {
					...
					if (collapsedNow) {
						try {
							localStorage.setItem("dsh-git-review.graphWidth", String(Math.round(graphListWidth ?? state.startWidth)));
						} catch {}
						return;
					}
					...
					try {
						localStorage.setItem("dsh-git-review.graphWidth", String(Math.round(final)));
					} catch {}
				};
				dragCleanupRef.current?.();
				dragCleanupRef.current = done;
			...
			const resetGraphWidth = (0, react.useCallback)(() => {
				setGraphListWidth(null);
				try {
					localStorage.removeItem("dsh-git-review.graphWidth");
				} catch {}
			}, []);
			const onGraphResizeKey = (0, react.useCallback)((event) => {
				if (event.key !== "ArrowLeft" && event.key !== "ArrowRight") return;
				event.preventDefault();
				const step = event.shiftKey ? 100 : 20;
				...
				try {
					localStorage.setItem("dsh-git-review.graphWidth", String(next));
				} catch {}
			...
			const [commitFilesFilter, setCommitFilesFilter] = (0, react.useState)("");
			const [commitTotals, setCommitTotals] = (0, react.useState)(null);
			const [copiedHash, setCopiedHash] = (0, react.useState)(false);
			const [blameReturn, setBlameReturn] = (0, react.useState)(null);
			const [blameFocus, setBlameFocus] = (0, react.useState)(null);
			const [pluginOpenReturn, setPluginOpenReturn] = (0, react.useState)(null);
			...
			const viewedStore = (0, react.useMemo)(() => createViewedStore(cwd), [cwd]);
			...
			const visibleGraph = (0, react.useMemo)(() => graphCommits.map((commit, index) => ({
				commit,
			...
			const mdText = (0, react.useMemo)(() => {
				...
				const table = new Map();
				for (const url of collectMdAssets(defanged).slice(0, 10)) {
			...
			(0, react.useEffect)(() => {
				if (viewTab !== "changes" || cwd === void 0 || selected === null) {
			...
			const imageSides = (0, react.useMemo)(() => {
				if (viewTab === "changes") {
				...
				return resolveImageSides({
					mode: "graph",
					scope: "all",
					baseRef: commitInfo !== null && commitInfo.parents.length > 0 ? commitInfo.parents[0] : null,
			...
			(0, react.useEffect)(() => {
				if (cwd === void 0 || imageSides === null || effectiveView === "file") {
				...
				loadImageSide(cwd, imageSides.before).then((next) => {
					if (alive) setBeforeBytes(next);
				});
				loadImageSide(cwd, imageSides.after).then((next) => {
					if (alive) setAfterBytes(next);
				});
				return () => {
					alive = false;
				};
			...
			const imageDiff = (0, react.useMemo)(() => {
				if (imageSides === null) return void 0;
				const label = (plan) => {
				...
				return {
					...
					view: imageSource ? "source" : "compare",
					onViewChange: (next) => {
						setImageSource(next === "source");
					},
			...
			const heldRefreshRef = (0, react.useRef)(false);
			...
			const writeBusyRef = (0, react.useRef)(false);
			...
			const lastExpandedWidthRef = (0, react.useRef)(void 0);
			const collapseGraphList = (0, react.useCallback)(() => {
			...
			const expandGraphList = (0, react.useCallback)(() => {
				if (lastExpandedWidthRef.current !== void 0) setGraphListWidth(lastExpandedWidthRef.current);
				setGraphListCollapsed(false);
				settings.set("graphCollapsed", false);
			}, [settings]);
			const expandForReading = (0, react.useCallback)(() => {
			...
			const jumpSelectCommit = (0, react.useCallback)((hash) => {
				setGraphWorktree(false);
				setGraphWorktreeFile(null);
				setSelectedCommit(hash);
				setGraphFile(null);
			...
			const jumpFromBlame = (0, react.useCallback)((hash, line) => {
			...
			const backToBlameFile = (0, react.useCallback)(() => {
			...
			const openCommitFileInPlugin = (0, react.useCallback)((path) => {
				if (selectedCommit === null) return;
				const origin = {
					commit: selectedCommit,
					graphFile
			...
			const backToGraphCommit = (0, react.useCallback)(() => {
			...
			(0, react.useEffect)(() => {
				if (fitTick !== 0) return;
				if (viewTab === "graph" && !graphListCollapsed && graphListWidth === null && fitWidth === null) setFitTick(1);
			}, [
				fitTick,
				viewTab,
				graphListCollapsed,
			...
			const executeWrite = (0, react.useCallback)(async (kind) => {
				if (cwd === void 0 || running || writeBusyRef.current) return;
			...
			const toggleAmend = (0, react.useCallback)((next) => {
				setAmend(next);
				if (next && cwd !== void 0 && commitMessage.trim() === "") {
					const cwdAtCall = cwd;
					hostCall("last-commit", { cwd }).then((payload) => {
						if (cwdAtCall !== cwdRef.current) return;
			...
			const data = ready;
			const rangeCommits = (0, react.useMemo)(() => {
				const out = new Map();
			...
			const rangeParents = (0, react.useMemo)(() => new Map(rangeCommits.map((commit) => [commit.hash, commit.parents])), [rangeCommits]);
			const headTipHash = (0, react.useMemo)(() => findBranchTip(rangeCommits, data?.branch ?? null), [rangeCommits, data]);
			...
			const invalidTargetHashes = (0, react.useMemo)(() => {
				if (baseHash === null) return null;
				const out = new Set();
				for (const commit of rangeCommits) if (commit.hash === baseHash || isAncestorOrSelf(rangeParents, commit.hash, baseHash)) out.add(commit.hash);
				return out;
			}, [
				rangeCommits,
				rangeParents,
			...
			const invalidBaseHashes = (0, react.useMemo)(() => {
				if (targetHash === null) return null;
				const out = new Set();
				for (const commit of rangeCommits) if (commit.hash === targetHash || isAncestorOrSelf(rangeParents, targetHash, commit.hash)) out.add(commit.hash);
				return out;
			}, [
				rangeCommits,
				rangeParents,
			...
			if (status.kind === "notRepo") {
				if (cwd === void 0) return (0, react_jsx_runtime.jsx)(CenteredState, {
					t,
					status: { kind: "noWorkspace" },
					onRetry: refresh
				});
				return (0, react_jsx_runtime.jsx)(NotRepoView, {
					cwd,
					root: status.root,
					t,
					onDidInit: refresh,
			...
			if (status.kind === "noWorkspace" || status.kind === "hostUnavailable" || status.kind === "error") return (0, react_jsx_runtime.jsx)(CenteredState, {
				t,
				status,
				onRetry: refresh
			});
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
											...
											!refsMode ? (0, react_jsx_runtime.jsxs)("span", {
												...
												children: [
													(0, react_jsx_runtime.jsx)(RefPicker, {
														...
														refs,
														commits: pickerCommits,
														exclude: targetRef ?? void 0,
														disabledHashes: invalidBaseHashes ?? void 0,
													...
													(0, react_jsx_runtime.jsx)(RefPicker, {
														...
														refs,
														commits: pickerCommits,
														exclude: baseRef ?? void 0,
														disabledHashes: invalidTargetHashes ?? void 0,
														headHash: headTipHash,
												...
												if (renameTarget === ref.name) return (0, react_jsx_runtime.jsxs)("div", {
													...
													children: [
														(0, react_jsx_runtime.jsx)("input", {
															...
															onKeyDown: (event) => {
																if (event.key === "Enter" && renameValue.trim() !== "" && renameValue.trim() !== ref.name && !running && !branchBusy) executeBranch("rename", {
																	name: ref.name,
					...
					fileMenu !== null && (0, react_jsx_runtime.jsx)(FileMenu, {
						...
						t
					}, (fileMenu.kind ?? "file") + ":" + fileMenu.path + "@" + fileMenu.x + ":" + fileMenu.y),
					historyState.kind === "open" && (0, react_jsx_runtime.jsxs)("div", {
						...
						onKeyDown: (event) => {
							if (event.key === "Escape") setHistoryState({ kind: "closed" });
						},
						children: [(0, react_jsx_runtime.jsx)("div", {
							className: review_module_css_default.pickerGroupLabel,
					...
					data?.truncated === true && viewTab === "changes" && (0, react_jsx_runtime.jsx)("div", {
						className: review_module_css_default.noticeRow,
						children: t("status.truncated")
					}),
					refsMode && rangeReady && viewTab === "changes" && data !== null && data.files.length === 0 && data.totals.added === 0 && data.totals.deleted === 0 && (0, react_jsx_runtime.jsxs)("div", {
						className: review_module_css_default.noticeRow,
						children: [
							(0, react_jsx_runtime.jsx)("span", { children: t("compare.emptyDirection") }),
							" ",
							(0, react_jsx_runtime.jsx)("button", {
								type: "button",
								className: review_module_css_default.scopeBtn,
								title: t("compare.swap"),
								onClick: swapEnds,
								children: t("compare.swap")
							})
						]
					}),
					(0, react_jsx_runtime.jsx)("div", {
						className: review_module_css_default.body,
						children: viewTab === "graph" ? (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
							(0, react_jsx_runtime.jsxs)("section", {
								ref: graphListRef,
								className: review_module_css_default.graphList + (graphListCollapsed ? " " + review_module_css_default.graphListNarrow : ""),
								style: !graphListCollapsed && effectiveGraphWidth !== null ? {
									width: effectiveGraphWidth,
									minWidth: effectiveGraphWidth
								} : void 0,
							...
							(0, react_jsx_runtime.jsx)("div", {
								className: review_module_css_default.graphResizeHandle,
								role: "separator",
								"aria-orientation": "vertical",
								"aria-label": t("graph.resizeHint"),
								"aria-valuemin": 120,
								"aria-valuemax": 900,
								"aria-valuenow": effectiveGraphWidth === null ? void 0 : effectiveGraphWidth,
								tabIndex: 0,
							...
							(0, react_jsx_runtime.jsx)("main", {
								...
								children: graphWorktree ? (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [(0, react_jsx_runtime.jsx)("div", {
										...
										children: [
											(0, react_jsx_runtime.jsx)("div", {
												...
												"data-git-review-tree": "",
												style: commitTreeWidth !== null ? { width: commitTreeWidth } : void 0,
											...
											(0, react_jsx_runtime.jsx)("span", {
												...
												"aria-valuemin": 160,
												"aria-valuemax": 480,
												"aria-valuenow": commitTreeWidth === null ? void 0 : commitTreeWidth,
												tabIndex: 0,
												title: t("tree.resizeHint"),
												onMouseDown: startCommitTreeResize,
												onDoubleClick: () => {
													setCommitTreeWidth(null);
													try {
														localStorage.removeItem("dsh-git-review.commitTreeWidth");
													} catch {}
												},
									...
									children: [
										...
										blameReturn !== null && (0, react_jsx_runtime.jsx)("button", {
											type: "button",
											className: review_module_css_default.returnFab,
											title: t("blame.backToFile") + ": " + blameReturn.path + ":" + blameReturn.line,
											onClick: backToBlameFile,
											children: "← " + t("blame.backToFile")
										})
						...
						] }) : (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsxs)("main", {
							className: review_module_css_default.mainPane,
							children: [selected === null || selectedFile === null || diff.kind === "idle" ? (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									pluginOpenReturn !== null && selected !== null && selectedFile === null && (0, react_jsx_runtime.jsx)("div", {
										className: review_module_css_default.emptyHint,
										children: t("graph.notInWorkspace")
									})
								]
								...
								onOpenExternal: cwd === void 0 ? void 0 : () => {
									openFileApp(selectedFile.path, "default");
								},
								t
							...
							"aria-valuemin": 200,
							"aria-valuemax": 460,
							"aria-valuenow": treeWidth === null ? void 0 : treeWidth,
							tabIndex: 0,
							title: t("tree.resizeHint"),
		...
		function NotRepoView({ cwd, root, t, onDidInit, openApps, useInput, inputActions, writable }) {
			...
			const [listTick, setListTick] = (0, react.useState)(0);
			const [listFailed, setListFailed] = (0, react.useState)(false);
			const [selected, setSelected] = (0, react.useState)(null);
			const [content, setContent] = (0, react.useState)({ kind: "idle" });
			const [initArmed, setInitArmed] = (0, react.useState)(false);
			...
			const openEntry = (0, react.useCallback)(async (path, app) => {
				const payload = await hostCall("open-with", {
					cwd,
					path,
					app,
			...
			const copyEntryPath = (0, react.useCallback)(async (path) => {
				try {
					await navigator.clipboard.writeText(path);
					return null;
				} catch {
			...
			const copyEntryName = (0, react.useCallback)(async (path) => {
				const name = path.split("/").pop() ?? path;
				try {
					await navigator.clipboard.writeText(name);
					return null;
			...
			const mutateEntry = (0, react.useCallback)(async (path, newPath) => {
				if (!writable) return t("commit.running");
				const payload = await hostCall("file-op", newPath !== void 0 ? {
					cwd,
					path,
					action: "rename",
					newPath,
			...
			const renameEntry = (0, react.useCallback)(async (path, newPath) => mutateEntry(path, newPath), [mutateEntry]);
			const removeEntry = (0, react.useCallback)(async (path) => mutateEntry(path), [mutateEntry]);
			(0, react.useEffect)(() => {
				if (selected === null) {
					setContent({ kind: "idle" });
					return;
			...
			const nrPreviewKind = nrKind === "markdown" ? nrPreviewMdOk ? "markdown" : null : nrKind === "image" || nrKind === "pdf" || nrKind === "html" ? nrKind : null;
			const nrMdFallback = (0, react.useMemo)(() => nrKind === "markdown" && content.kind === "content" ? htmlFallbackForPreview(content.content) : null, [nrKind, content]);
			const nrMdText = (0, react.useMemo)(() => {
			...
			(0, react.useEffect)(() => {
				...
				if (kind === "image" && selected.toLowerCase().endsWith(".svg")) {
					setPreviewBytes({ kind: "idle" });
					return;
				}
				let alive = true;
				setPreviewBytes({ kind: "loading" });
				loadPreviewBytes(cwd, selected).then((next) => {
					if (alive) setPreviewBytes(next);
				});
				return () => {
					alive = false;
			...
			const init = () => {
				...
				hostCall("git-init", {
					...
					setInitBusy(false);
					if (payload === null || !payload.ok) {
						setInitError(payload === null ? t("state.hostUnavailable") : payload.error ?? t("state.error"));
						return;
					}
					setInitArmed(false);
					onDidInit();
			...
			const syntheticFile = selected !== null ? {
				path: selected,
				x: "?",
				y: "?",
				added: 0,
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
						...
						children: [(0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								(0, react_jsx_runtime.jsx)("span", {
									...
									children: t("state.notRepo.gitDisabled")
								}),
								...
								(0, react_jsx_runtime.jsx)("button", {
									...
									disabled: initBusy,
									onClick: init,
									title: t("state.notRepo.initHint"),
									children: (0, react_jsx_runtime.jsx)("span", { children: initArmed ? t("state.notRepo.confirmInit") : t("state.notRepo.init") })
								}),
								initArmed && (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									className: review_module_css_default.toolBtn,
									disabled: initBusy,
									onClick: () => {
									...
									children: (0, react_jsx_runtime.jsx)("span", { children: t("menu.cancel") })
								})
							]
						}), initError !== null && (0, react_jsx_runtime.jsx)("div", {
							className: review_module_css_default.noticeRow + " " + review_module_css_default.noticeError,
							children: initError
						})]
					}),
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [(0, react_jsx_runtime.jsxs)("div", {
							style: {
								width: 280,
								maxWidth: "40%",
								borderRight: "1px solid var(--dsw-alias-border-secondary)",
								overflowY: "auto",
								padding: 8
							},
							children: [
								(0, react_jsx_runtime.jsxs)("div", {
									...
									children: [(0, react_jsx_runtime.jsx)("button", {
										...
										onClick: goUp,
										title: t("state.notRepo.up"),
										children: (0, react_jsx_runtime.jsx)("span", { children: t("state.notRepo.up") })
									}), (0, react_jsx_runtime.jsx)("span", {
										style: {
											overflow: "hidden",
										...
										title: root + (dir === "." ? "" : " / " + dir),
										children: dir === "." ? root : dir
									})]
								}),
								entries === null && (0, react_jsx_runtime.jsx)("div", {
									className: review_module_css_default.paneNotice,
									children: t("state.notRepo.listLoading")
								}),
								entries !== null && listFailed && (0, react_jsx_runtime.jsx)("div", {
									className: review_module_css_default.noticeRow + " " + review_module_css_default.noticeError,
									children: t("state.notRepo.listFailed")
								}),
								entries !== null && !listFailed && entries.length === 0 && (0, react_jsx_runtime.jsx)("div", {
									className: review_module_css_default.paneNotice,
									children: t("state.notRepo.dirEmpty")
								}),
								entries !== null && !listFailed && entries.map((entry) => (0, react_jsx_runtime.jsxs)("button", {
									type: "button",
									onClick: () => {
									...
									style: {
										...
										padding: "4px 6px",
										borderRadius: 6,
										background: selected === entry.path ? "var(--dsw-alias-interactive-bg-hover)" : "transparent",
										border: "none",
										cursor: "pointer",
										fontSize: 13
									},
								...
								segments.length > 0 && (0, react_jsx_runtime.jsxs)("div", {
									style: {
										marginTop: 8,
										fontSize: 12,
										display: "flex",
									...
									}), segments.map((segment, index) => (0, react_jsx_runtime.jsx)("button", {
										type: "button",
										className: review_module_css_default.toolBtn,
										onClick: () => setDir(segments.slice(0, index + 1).join("/")),
										children: (0, react_jsx_runtime.jsx)("span", { children: segment })
							...
							children: [
								selected === null && (0, react_jsx_runtime.jsx)("div", {
									className: review_module_css_default.paneNotice,
									children: t("state.notRepo.hint") + " " + t("state.notRepo.initHint")
								}),
								selected !== null && content.kind === "loading" && nrPreviewKind === null && (0, react_jsx_runtime.jsx)("div", {
									className: review_module_css_default.paneNotice,
									children: t("file.loading")
								}),
								selected !== null && content.kind === "failed" && (0, react_jsx_runtime.jsx)("div", {
									className: review_module_css_default.noticeRow + " " + review_module_css_default.noticeError,
									children: content.message
								}),
								selected !== null && content.kind === "binary" && (nrPreviewKind === null || nrKind === "html" || nrSvg || nrKind === "markdown") && (0, react_jsx_runtime.jsx)("div", {
									className: review_module_css_default.paneNotice,
									children: t("diff.binary")
								}),
								selected !== null && syntheticFile !== null && nrPreviewKind !== null && !previewSource && content.kind !== "failed" && (nrPreviewKind === "markdown" ? content.kind === "content" || content.kind === "loading" ? (0, react_jsx_runtime.jsx)(PreviewPane, {
									file: syntheticFile,
									kind: "markdown",
									text: nrMdText,
									...
									t
								}) : null : nrPreviewKind === "html" || nrSvg ? content.kind === "content" ? (0, react_jsx_runtime.jsx)(PreviewPane, {
									file: syntheticFile,
									kind: nrPreviewKind,
									...
									onOpenExternal: selected !== null ? () => {
										openEntry(selected, "default");
									} : void 0,
									t
								}) : null : previewBytes.kind === "ready" && !previewBytes.truncated && (nrPreviewKind === "pdf" ? previewBytes.mime === "application/pdf" : previewBytes.mime.startsWith("image/")) ? (0, react_jsx_runtime.jsx)(PreviewPane, {
									file: syntheticFile,
									kind: nrPreviewKind,
									text: "",
									textLoading: false,
									...
									t
								}) : previewBytes.kind === "failed" || previewBytes.kind === "ready" && (previewBytes.truncated || (nrPreviewKind === "pdf" ? previewBytes.mime !== "application/pdf" : !previewBytes.mime.startsWith("image/"))) ? (0, react_jsx_runtime.jsx)("div", {
									className: review_module_css_default.paneNotice,
									children: previewBytes.kind === "ready" && previewBytes.truncated ? t("preview.tooLarge") : t("preview.loadFailed")
								}) : content.kind === "loading" || previewBytes.kind === "loading" ? (0, react_jsx_runtime.jsx)("div", {
									className: review_module_css_default.paneNotice,
									children: t("preview.loading")
								}) : null),
								selected !== null && content.kind === "content" && syntheticFile !== null && (nrPreviewKind === null || previewSource) && (0, react_jsx_runtime.jsx)(FilePane, {
									file: syntheticFile,
									search: { query: "" },
					...
					menu !== null && (0, react_jsx_runtime.jsx)(FileMenu, {
						state: menu,
						apps: openApps,
						writable,
						refsMode: true,
						...
						remove: removeEntry,
						t
					}, (menu.kind ?? "file") + ":" + menu.path + "@" + menu.x + ":" + menu.y)
				]
			});
		}
		...
		function PrefRows({ t, reviewSettings, set }) {
		...
		function SettingsCard({ t, reviewSettings, set }) {
			...
			return (0, react_jsx_runtime.jsxs)("li", {
				...
				children: [(0, react_jsx_runtime.jsxs)("button", {
					...
					children: (0, react_jsx_runtime.jsx)(PrefRows, {
						t,
						reviewSettings,
						set
					})
		...
		function SettingsPanel({ view, t, reviewSettings, set }) {
			if (view === "summary") return (0, react_jsx_runtime.jsx)(react_jsx_runtime.Fragment, { children: t("settings.description") });
			return (0, react_jsx_runtime.jsx)("div", {
				className: review_module_css_default.pluginPanelBody,
				children: (0, react_jsx_runtime.jsx)(PrefRows, {
					t,
					reviewSettings,
					set
		...
		function configFormScope(form) {
			return {
				...
				set: (field, value) => form.set(field, value).then(() => void 0)
			};
		}
					...
					const sync = () => {
						...
						if (!migrated) {
							...
							if (raw === null) migrated = true;
								...
								} else if (fields !== null && !snap.writable) {} else {
		...
		const zh = {
			...
			"graph.resizeHint": "拖拽调整列表宽度，双击恢复默认",
			"graph.backToGraph": "返回图谱",
			"graph.notInWorkspace": "该文件不在当前工作区文件列表中，可用工具栏返回图谱。",
			"commit.title": "提交或推送",
			"commit.message": "提交信息",
			...
			"compare.emptyDirection": "该方向没有差异：右端不包含左端之外的新提交，可交换两端后重试",
			"picker.emptyAll": "空仓库：提交一次后，这里会出现分支与提交",
			"menu.loadingApps": "正在读取应用列表…",
			"menu.copyPath": "复制路径",
			"menu.copyName": "复制文件名",
			"menu.copyDirName": "复制文件夹名",
			...
			"menu.confirmDeleteDirTitle": "确认删除文件夹（含其中全部内容）",
			"menu.stage": "暂存",
			"menu.unstage": "取消暂存",
			"menu.discard": "放弃更改…",
			"menu.confirmDiscardTitle": "放弃此文件的未提交更改",
			"menu.confirmDiscardDirTitle": "放弃此文件夹内文件的未提交更改",
			...
			"state.error": "读取失败",
			"status.truncated": "文件列表过大，仅显示前部结果（已截断）",
			"diff.loading": "读取差异中…",
			...
			"preview.scriptNotice": "此页面包含脚本或画布内容，安全预览不运行脚本，动画与交互不会生效",
			"preview.scriptOpen": "在浏览器打开",
			"preview.copy": "复制",
			"preview.copied": "已复制",
			"preview.footnotes": "脚注",
			"image.compare": "图片",
			"image.source": "源码",
			"image.mode.label": "图片对比模式",
			"image.mode.side": "并排",
			"image.mode.swipe": "滑动",
			"image.mode.onion": "叠加",
			"image.mode.difference": "差异",
			"image.missingSide": "此侧无文件",
			"image.oneSide": "此对比只有一侧存在文件",
			"image.swipeHint": "拖动分割线（左右方向键微调）",
			"image.onionHint": "调整上层图片透明度",
			"image.diffHint": "差异像素高亮（相同像素为黑）",
			"preview.zoomIn": "放大",
			"preview.zoomOut": "缩小",
			"preview.zoomFit": "适应",
			...
			"history.resetHardArm": "再次点击确认硬重置",
		...
		const en = {
			...
			"search.files": "{count} file(s) match",
			...
			"picker.truncated": "Showing first {count} commit(s) — type to narrow",
			...
			"graph.filesCount": "{count} file(s) changed",
			...
			"graph.copied": "Copied",
			"graph.worktree": "Uncommitted changes ({count} file(s))",
			"graph.collapseList": "Collapse the commit list (topology rows stay clickable)",
			"graph.expandList": "Expand the commit list",
			"graph.resizeHint": "Drag to resize the list; double-click to reset",
			"graph.backToGraph": "Back to graph",
			"graph.notInWorkspace": "This file is not in the current workspace file list; jump back to the graph from the toolbar.",
			...
			"menu.openInPlugin": "Open in plugin",
			...
			"compare.emptyDirection": "No changes in this direction: the right end has nothing beyond the left — try swapping the ends",
			"picker.emptyAll": "Empty repository: branches and commits appear here after the first commit",
			"menu.loadingApps": "Loading apps…",
			"menu.copyPath": "Copy path",
			"menu.copyName": "Copy file name",
			"menu.copyDirName": "Copy folder name",
			"menu.addToChat": "Add to conversation",
			"menu.rename": "Rename…",
			"menu.confirmRename": "Confirm rename",
			"menu.delete": "Delete…",
			"menu.confirmDelete": "Confirm delete",
			"menu.confirmDeleteTitle": "Delete file",
			"menu.confirmDeleteDirTitle": "Delete folder (with everything inside)",
			"menu.stage": "Stage",
			"menu.unstage": "Unstage",
			"menu.discard": "Discard changes…",
			"menu.confirmDiscardTitle": "Discard this file’s uncommitted changes",
			"menu.confirmDiscardDirTitle": "Discard uncommitted changes of files in this folder",
			...
			"status.truncated": "File list truncated at the host cap — showing the first entries",
			...
			"preview.scriptNotice": "This page relies on scripts or canvas, which the sandboxed preview never runs — animations and interactions stay inert",
			"preview.scriptOpen": "Open in browser",
			"preview.copy": "Copy",
			"preview.copied": "Copied",
			"preview.footnotes": "Footnotes",
			"image.compare": "Image",
			"image.source": "Source",
			"image.mode.label": "Image comparison mode",
			"image.mode.side": "2-up",
			"image.mode.swipe": "Swipe",
			"image.mode.onion": "Onion",
			"image.mode.difference": "Difference",
			"image.missingSide": "No file on this side",
			"image.oneSide": "Only one side of this comparison has a file",
			"image.swipeHint": "Drag the divider (arrow keys nudge it)",
			"image.onionHint": "Adjust the top layer opacity",
			"image.diffHint": "Difference blend — identical pixels turn black",
			...
			"tree.pending": "{count} file(s) pending review",
			"tree.showMore": "Show more ({count} remaining)",
			"aheadBehind.title": "{ahead} ahead of / {behind} behind the upstream",
			"conflict.inProgress": "{kind} in progress · {count} conflicted file(s)",
			...
			"history.resetHardArm": "Click again to confirm the hard reset",
		...
		function apply(ctx) {
			...
			const publishPreferenceSurface = (scoped) => {
				...
				}, (props) => (0, react.createElement)(SettingsPanel, props)));
			};
			...
			ctx.inject(["settingsScope"], (raw) => {
				if (settingsBound || ctx.get("configForms") !== void 0) return;
				const scoped = raw;
