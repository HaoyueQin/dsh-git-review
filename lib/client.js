	...
	factory: (require) => {
		...
		function OptionsIcon({ size = 13 }) {
			return (0, react_jsx_runtime.jsxs)("svg", {
				...
				"aria-hidden": "true",
				children: [
					(0, react_jsx_runtime.jsx)("path", { d: "M2.5 4.5h11M2.5 8h11M2.5 11.5h11" }),
					(0, react_jsx_runtime.jsx)("circle", {
						cx: "6",
						cy: "4.5",
						r: "1.4",
		...
		var review_module_css_default = {
			...
			"branchChip": "review-module_branchChip",
			...
			"branchSelect": "review-module_branchSelect",
			...
			"prefCard": "review-module_prefCard",
			"prefCardHead": "review-module_prefCardHead",
			"prefDescription": "review-module_prefDescription",
			"prefHint": "review-module_prefHint",
			"prefLabel": "review-module_prefLabel",
			"prefNote": "review-module_prefNote",
			"prefRow": "review-module_prefRow",
			"prefRowText": "review-module_prefRowText",
			"prefTitle": "review-module_prefTitle",
			...
			"searchOptions": "review-module_searchOptions",
			"searchOptionsBtn": "review-module_searchOptionsBtn",
			...
			"toolbarSpacer": "review-module_toolbarSpacer",
		...
		function FileMenu({ state, apps, writable, refsMode, useInput, inputActions, onClose, openApp, copyPath, copyName, rename, remove, t }) {
			...
			const draft = useInput !== void 0 ? useInput((s) => s.draft) : "";
			const addToChat = (path) => {
				if (useInput === void 0 || inputActions === void 0) return Promise.resolve(t("menu.chatUnavailable"));
				...
				return (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						(0, react_jsx_runtime.jsx)("input", {
							...
							onKeyDown: (event) => {
								if (event.key === "Enter") run("rename", () => rename(state.path, renameValue.trim()));
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
						...
						canChat && (0, react_jsx_runtime.jsxs)("button", {
							type: "button",
							className: review_module_css_default.fileMenuItem,
							onClick: () => {
								run("chat", () => addToChat(state.path));
							},
							children: [(0, react_jsx_runtime.jsx)("span", {
								className: review_module_css_default.fileMenuItemIcon,
		...
		function CommitGraph({ commits, lanes, selected, onSelect, collapsed = false, t }) {
			...
			if (collapsed) return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [commits.map((commit, index) => (0, react_jsx_runtime.jsxs)("button", {
					type: "button",
				...
				}, commit.hash)), tip !== null && (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [(0, react_jsx_runtime.jsx)("div", {
						...
						children: [
							...
							showCommits && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
								...
								q !== "" && commitsMatch.length === 0 && commits !== null && (0, react_jsx_runtime.jsx)("div", {
		...
		function highlightedLine(text, engine) {
		...
		function FilePane({ file, search, content, truncated, binary, size, loading, canShowDiff, view, onViewChange, t }) {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					binary && (0, react_jsx_runtime.jsx)("div", {
						...
						children: size > 0 ? t("diff.binarySize", { size }) : t("diff.binary")
					}),
		...
		function renderCellText(cell, engine) {
			if (cell === null) return "";
		...
		function UnifiedRow({ line, engine, ordinal, active, commentTitle, onComment }) {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(0, react_jsx_runtime.jsxs)("span", {
						className: review_module_css_default.cellText + (line.kind === "del" ? " " + review_module_css_default.cellTextDel : line.kind === "add" ? " " + review_module_css_default.cellTextAdd : ""),
						children: [renderCellText({
							no: line.no,
							text: line.text,
							noNewline: line.noNewline
						}, engine), line.noNewline === true && (0, react_jsx_runtime.jsx)("em", {
		...
		function Row({ row, engine, matchOrdinal, active, commentTitle, onComment }) {
			const kindClass = row.kind === "ctx" ? review_module_css_default.rowCtx : row.kind === "del" ? review_module_css_default.rowDel : row.kind === "add" ? review_module_css_default.rowAdd : review_module_css_default.rowPair;
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(0, react_jsx_runtime.jsxs)("span", {
						...
						children: [renderCellText(row.left, engine), row.left?.noNewline === true && (0, react_jsx_runtime.jsx)("em", {
							className: review_module_css_default.noNewline,
							children: "↩"
						})]
					}),
					...
					(0, react_jsx_runtime.jsxs)("span", {
						...
						children: [renderCellText(row.right, engine), row.right?.noNewline === true && (0, react_jsx_runtime.jsx)("em", {
							className: review_module_css_default.noNewline,
							children: "↩"
						})]
					}),
					onComment !== void 0 && (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						className: review_module_css_default.rowCommentBtn,
						title: commentTitle,
						"aria-label": commentTitle,
						onClick: () => {
							onComment(row.right !== null ? row.right.no : 0);
						},
						children: (0, react_jsx_runtime.jsx)(CommentIcon, {})
					})
				]
		...
		function DiffPane({ file, diff, truncated, loading, binary, size, full, onToggleFull, scope, onScopeChange, view, onViewChange, showViewSwitch = true, allowFileView = true, search, baseActive, useInput, inputActions, t }) {
			...
			(0, react.useEffect)(() => {
				...
				(scrollRef.current?.querySelectorAll("[data-diff-match]"))?.[activeMatch]?.scrollIntoView({ block: "center" });
			}, [
				activeMatch,
				engine,
				matchRowCount
							...
							matchRowCount > 0 && (0, react_jsx_runtime.jsxs)("span", {
								...
								children: [
									...
									(0, react_jsx_runtime.jsx)("span", {
										...
										children: activeMatch + 1 + " / " + matchRowCount
									}),
									(0, react_jsx_runtime.jsx)("button", {
										type: "button",
										className: review_module_css_default.toolBtn,
		...
		function renderHunks(parsed, ui) {
			...
			if (budget <= 0) out.push((0, react_jsx_runtime.jsx)("div", {
				className: review_module_css_default.noticeRow,
		...
		const PREFS_EVENT = "dsh-git-review:prefs-change";
		const DEFAULT_PREFS = {
			viewMode: "split",
			searchScope: "diff",
		...
		function readPrefs() {
			return loadPrefs(typeof localStorage === "undefined" ? void 0 : localStorage);
		}
		...
		function TreePanel({ files, selected, onSelect, filter, onFilterChange, collapsed, onToggleDir, mode, onModeChange, showModeRow = true, showFilter = true, listFailed, matchCounts, onFileMenu, t }) {
		...
		async function loadStatus(cwd, base, target) {
		...
		async function loadFileDiff(cwd, path, origPath, untracked, full, scope, base, target) {
		...
		async function loadFileContent(cwd, path) {
			const payload = await hostCall("file-content", {
				cwd,
				path
			});
			if (payload === null) return {
		...
		function ReviewView({ cwd, t, useSession, useInput, inputActions }) {
			...
			const initialPrefs = (0, react.useMemo)(() => readPrefs(), []);
			...
			const [searchMenu, setSearchMenu] = (0, react.useState)(null);
			...
			const searchScopeRef = (0, react.useRef)(null);
			const searchMatchRef = (0, react.useRef)(null);
			(0, react.useEffect)(() => {
			...
			(0, react.useEffect)(() => {
				...
				const onDown = (event) => {
					...
					if (root !== null && !root.contains(event.target)) setSearchMenu(null);
				};
				document.addEventListener("mousedown", onDown);
				return () => {
					document.removeEventListener("mousedown", onDown);
			...
			(0, react.useEffect)(() => {
				writePrefs({
					viewMode: viewMode === "file" ? "split" : viewMode,
					searchScope,
					graphCollapsed: graphListCollapsed,
					searchCS,
					searchRegex
				});
			}, [
			...
			(0, react.useEffect)(() => {
				...
				loadStatus(cwd, baseRef, refsMode ? targetRef : null).then((next) => {
			...
			const effectiveView = selectedFile?.unchanged === true ? "file" : viewMode;
			(0, react.useEffect)(() => {
				...
				(selectedFile.unchanged === true || effectiveView === "file" ? loadFileContent(cwd, selected) : loadFileDiff(cwd, selected, selectedFile.origPath, selectedFile.untracked, diffFull, diffScope, baseRef, refsMode ? targetRef : null)).then((next) => {
			...
			(0, react.useEffect)(() => {
				...
				loadFileDiff(cwd, graphFileInfo.path, graphFileInfo.origPath, false, diffFull, "all", parent0, selectedCommit).then((next) => {
					if (alive) setDiff(next);
				});
				return () => {
					alive = false;
						...
						children: [
							(0, react_jsx_runtime.jsxs)("button", {
								...
								children: [
									...
									(0, react_jsx_runtime.jsx)(ChevronIcon, { rotated: branchOpen })
								]
							}),
							(0, react_jsx_runtime.jsx)("span", {
								className: review_module_css_default.scopeSwitch,
							...
							!refsMode ? (0, react_jsx_runtime.jsxs)("span", {
								...
								children: [
									...
									(0, react_jsx_runtime.jsxs)("span", {
										...
										children: [(0, react_jsx_runtime.jsx)(FileIcon, {}), (0, react_jsx_runtime.jsx)("span", { children: t("compare.worktree") })]
									})
								]
							}) : (0, react_jsx_runtime.jsxs)("span", {
								...
								children: [
									(0, react_jsx_runtime.jsxs)("span", {
										...
										children: [(0, react_jsx_runtime.jsxs)("button", {
											...
											onClick: () => {
												setSearchMenu((value) => value === "scope" ? null : "scope");
											},
											children: [(0, react_jsx_runtime.jsx)("span", { children: t("search.scope." + searchScope) }), (0, react_jsx_runtime.jsx)(ChevronIcon, {
												size: 10,
												rotated: searchMenu === "scope"
											})]
										}), searchMenu === "scope" && (0, react_jsx_runtime.jsx)("div", {
									...
									(0, react_jsx_runtime.jsxs)("label", {
										...
										children: [
											...
											searchScope !== "path" && search !== "" && (0, react_jsx_runtime.jsx)("span", {
									...
									(0, react_jsx_runtime.jsxs)("span", {
										className: review_module_css_default.searchOptions,
										ref: searchMatchRef,
										children: [(0, react_jsx_runtime.jsx)("button", {
											type: "button",
											className: review_module_css_default.toolBtn + " " + review_module_css_default.searchOptionsBtn,
											title: t("search.matching"),
											"aria-label": t("search.matching"),
											"aria-expanded": searchMenu === "match",
											onClick: () => {
												setSearchMenu((value) => value === "match" ? null : "match");
											},
											children: (0, react_jsx_runtime.jsx)(OptionsIcon, {})
										}), searchMenu === "match" && (0, react_jsx_runtime.jsxs)("div", {
											className: review_module_css_default.searchOptionsPop,
											role: "menu",
											children: [(0, react_jsx_runtime.jsxs)("button", {
												type: "button",
							...
							(0, react_jsx_runtime.jsx)("span", { className: review_module_css_default.toolbarSpacer }),
							(0, react_jsx_runtime.jsx)("span", {
								className: review_module_css_default.scopeSwitch,
								role: "group",
								"aria-label": t("view.label"),
								children: ["changes", "graph"].map((candidate) => (0, react_jsx_runtime.jsxs)("button", {
									...
									children: [candidate === "changes" ? null : (0, react_jsx_runtime.jsx)(GraphIcon, {}), (0, react_jsx_runtime.jsx)("span", { children: t("viewTab." + candidate) })]
								}, candidate))
							}),
							(0, react_jsx_runtime.jsxs)("button", {
								type: "button",
								...
								onClick: refresh,
								title: t("refresh"),
								children: [(0, react_jsx_runtime.jsx)(RefreshIcon, {}), (0, react_jsx_runtime.jsx)("span", { children: status.kind === "loading" ? t("refreshing") : t("refresh") })]
							}),
							(0, react_jsx_runtime.jsxs)("button", {
								type: "button",
								className: review_module_css_default.toolBtn + " " + review_module_css_default.commitToggle,
							...
							(0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									(refs ?? []).some((ref) => ref.kind === "remote") && (0, react_jsx_runtime.jsxs)("details", {
										...
										children: [(0, react_jsx_runtime.jsx)("summary", { children: t("branch.remote") }), (refs ?? []).filter((ref) => ref.kind === "remote").map((ref) => (0, react_jsx_runtime.jsx)("div", {
					...
					(0, react_jsx_runtime.jsx)("div", {
						...
						children: viewTab === "graph" ? (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsxs)("section", {
							...
							children: [
								...
								logState.kind === "ready" && graphCommits.length > 0 && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [logState.truncated && (0, react_jsx_runtime.jsx)("div", {
									className: review_module_css_default.noticeRow,
									children: t("graph.truncated", { count: graphCommits.length })
							...
							children: selectedCommit === null || commitInfo === null ? (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [(0, react_jsx_runtime.jsxs)("div", {
									...
									children: [(0, react_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											commitTotals !== null && (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)("span", {
												className: review_module_css_default.commitInfoLabel,
												children: t("graph.field.changes")
							...
							}) : effectiveView === "file" ? (0, react_jsx_runtime.jsx)(FilePane, {
								file: selectedFile,
						...
						}), data !== null && (0, react_jsx_runtime.jsx)(TreePanel, {
		...
		function PrefRow({ label, hint, value, options, onChange }) {
			return (0, react_jsx_runtime.jsxs)("div", {
				className: review_module_css_default.prefRow,
				children: [(0, react_jsx_runtime.jsxs)("div", {
					className: review_module_css_default.prefRowText,
					children: [(0, react_jsx_runtime.jsx)("span", {
						className: review_module_css_default.prefLabel,
						children: label
					}), (0, react_jsx_runtime.jsx)("span", {
						className: review_module_css_default.prefHint,
						children: hint
					})]
				}), (0, react_jsx_runtime.jsx)("span", {
					className: review_module_css_default.scopeSwitch,
					...
					children: options.map((option) => (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						className: review_module_css_default.scopeBtn + (value === option.key ? " " + review_module_css_default.scopeBtnActive : ""),
						onClick: () => {
							onChange(option.key);
						},
		...
		function SettingsCard(_props) {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				className: review_module_css_default.prefCard,
				children: [
					(0, react_jsx_runtime.jsxs)("div", {
						className: review_module_css_default.prefCardHead,
						children: [(0, react_jsx_runtime.jsx)("span", {
							className: review_module_css_default.prefTitle,
							children: t("settings.title")
						}), (0, react_jsx_runtime.jsx)("span", {
							className: review_module_css_default.prefDescription,
					...
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [(0, react_jsx_runtime.jsxs)("div", {
							...
							children: [["cs", t("search.flagCS")], ["rx", t("search.flagRegex")]].map(([key, label]) => {
								const active = key === "cs" ? prefs.searchCS : prefs.searchRegex;
								return (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									className: review_module_css_default.scopeBtn + (active ? " " + review_module_css_default.scopeBtnActive : ""),
									onClick: () => {
					...
					(0, react_jsx_runtime.jsx)("span", {
						className: review_module_css_default.prefNote,
		...
		const zh = {
			...
			"settings.scopeHint": "工具条搜索框默认搜索的内容：差异内容 / 文件内容 / 文件名",
			...
			"settings.matchingHint": "区分大小写与正则表达式的默认开关",
			"settings.instantNote": "偏好保存在本浏览器；标签页内的切换同样会写回这里。",
			"ref.branches": "本地分支",
			"ref.remotes": "远程分支",
			"ref.tags": "标签",
			"ref.commits": "提交",
		...
		const en = {
			...
			"search.caseSensitive": "Case sensitive (Aa)",
			...
			"settings.scopeHint": "What the toolbar search targets by default: diff content / file content / file names",
			...
			"settings.matchingHint": "Default state of the case-sensitive and regex toggles",
			"settings.instantNote": "Preferences live in this browser; flips inside the tab write back to the same store.",
		...
		function apply(ctx) {
			...
			ctx.slots.inject("conversation.view", () => ctx.slots.register({
				...
				locale: NS,
				label: () => t("tab"),
				inject: (sessionId) => ({ cwd: ctx.sessions.list.getSnapshot().byId[sessionId]?.cwd })
			}, ReviewView));
