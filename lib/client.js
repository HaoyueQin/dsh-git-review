window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function renderCellText(cell, engine, spans, changedClass) {
			if (cell === null) return "";
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(0, react_jsx_runtime.jsxs)("span", {
						...
						}, engine, spans, changedClass), line.noNewline === true && (0, react_jsx_runtime.jsx)("em", {
		...
		function Row({ row, engine, words, matchOrdinal, active, commentTitle, onComment }) {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(0, react_jsx_runtime.jsxs)("span", {
						...
						children: [renderCellText(row.left, engine, regions?.old ?? null, review_module_css_default.wordDel), row.left?.noNewline === true && (0, react_jsx_runtime.jsx)("em", {
							className: review_module_css_default.noNewline,
							children: "↩"
						})]
					}),
					...
					(0, react_jsx_runtime.jsxs)("span", {
						...
						children: [renderCellText(row.right, engine, regions?.new ?? null, review_module_css_default.wordAdd), row.right?.noNewline === true && (0, react_jsx_runtime.jsx)("em", {
							className: review_module_css_default.noNewline,
							children: "↩"
						})]
					}),
		...
		function DiffPane({ file, diff, truncated, loading, binary, size, full, onToggleFull, scope, onScopeChange, view, onViewChange, showViewSwitch = true, allowFileView = true, wsIgnore, onToggleWs, search, baseActive, useInput, inputActions, onDraftAdd, t }) {
		...
		function TreePanel({ files, selected, onSelect, filter, onFilterChange, collapsed, onToggleDir, mode, onModeChange, showModeRow = true, showFilter = true, listFailed, matchCounts, viewedHas, onToggleViewed, pendingCount, onFileMenu, t }) {
		...
		function ReviewView({ cwd, settings, t, useSession, useInput, inputActions }) {
			...
			const viewedStore = (0, react.useMemo)(() => createViewedStore(), []);
			...
			(0, react.useEffect)(() => {
				...
				(selectedFile.unchanged === true || effectiveView === "file" ? loadFileContent(cwd, selected) : loadFileDiff(cwd, selected, selectedFile.origPath, selectedFile.untracked, diffFull, diffScope, baseRef, refsMode ? targetRef : null, wsIgnore)).then((next) => {
				...
				children: [
					(0, react_jsx_runtime.jsxs)("header", {
						...
						children: [
							...
							(0, react_jsx_runtime.jsxs)("button", {
								type: "button",
								className: review_module_css_default.toolBtn + " " + review_module_css_default.commitToggle + (draftList.length > 0 ? " " + review_module_css_default.toolBtnActive : ""),
								...
								children: [
									(0, react_jsx_runtime.jsx)(CommentIcon, {}),
									(0, react_jsx_runtime.jsx)("span", { children: t("comment.draftsTitle") }),
									draftList.length > 0 && (0, react_jsx_runtime.jsx)("span", {
										className: review_module_css_default.badge,
										children: String(draftList.length)
									})
								]
							}),
							(0, react_jsx_runtime.jsxs)("button", {
		...
		function prefsEqual(a, b) {
			return a.viewMode === b.viewMode && a.searchScope === b.searchScope && a.graphCollapsed === b.graphCollapsed && a.searchCS === b.searchCS && a.searchRegex === b.searchRegex && a.wsIgnore === b.wsIgnore;
		}
