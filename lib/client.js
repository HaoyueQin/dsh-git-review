window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function DiffPane({ file, diff, truncated, loading, binary, size, full, onToggleFull, scope, onScopeChange, t }) {
		...
		function TreePanel({ files, selected, onSelect, filter, onFilterChange, collapsed, onToggleDir, t }) {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [(0, react_jsx_runtime.jsxs)("label", {
					...
					children: visible.length === 0 ? (0, react_jsx_runtime.jsx)("div", {
						...
						children: t(files.length === 0 ? "tree.noChanges" : "tree.empty")
		...
		function ReviewView({ cwd, t }) {
			...
			const selectedFile = (0, react.useMemo)(() => ready?.files.find((file) => file.path === selected) ?? null, [ready, selected]);
			(0, react.useEffect)(() => {
				...
				loadFileDiff(cwd, selected, selectedFile.origPath, selectedFile.untracked, diffFull, diffScope).then((next) => {
