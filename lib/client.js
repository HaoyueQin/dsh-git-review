	...
	factory: (require) => {
		...
		function CommitGraph({ commits, lanes, selected, onSelect, collapsed = false, t }) {
			...
			if (collapsed) return (0, react_jsx_runtime.jsx)("div", {
				...
				children: commits.map((commit, index) => (0, react_jsx_runtime.jsx)("button", {
					type: "button",
