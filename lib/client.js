window.__ModuleLoader__.load({
	...
	factory: (require) => {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					binary && (0, react_jsx_runtime.jsx)("div", {
						...
						children: (size > 0 ? t("diff.binarySize", { size }) : t("diff.binary")) + " · " + t("preview.openHint")
					}),
		...
		function PreviewPane({ file, kind, text, textLoading, dataUrl, bytesFailed, bytesTruncated, onShowSource, t }) {
				...
				children: [(0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						kind === "markdown" && (textLoading ? (0, react_jsx_runtime.jsx)("div", {
							className: review_module_css_default.paneNotice,
							children: t("file.loading")
						}) : Markdown !== null ? (0, react_jsx_runtime.jsx)("div", {
						...
						kind === "image" && (dataUrl !== null && !bytesTruncated ? (0, react_jsx_runtime.jsx)("img", {
		...
		function ReviewView({ cwd, settings, t, useSession, useInput, inputActions }) {
			...
			const showPreview = previewAvailable && !previewSource && (previewKind === "markdown" || previewSvg ? diff.kind === "content" : true);
