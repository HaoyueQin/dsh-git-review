	...
	factory: (require) => {
		...
		function ReviewView({ cwd: injectedCwd, sessionId, sessionsList, settings, t, useSession, useInput, inputActions }) {
			...
			const startGraphResize = (0, react.useCallback)((event) => {
				...
				const clamp = (value) => Math.min(900, Math.max(120, value));
				let raf = 0;
				let latest = 0;
				const onMove = (move) => {
			...
			const expandForReading = (0, react.useCallback)(() => {
				...
				if (graphListWidth === null && lastExpandedWidthRef.current === void 0) setGraphListWidth(GRAPH_READING_WIDTH);
			}, [
				graphListCollapsed,
				expandGraphList,
				graphListWidth
						...
						children: [
							...
							viewTab === "graph" ? (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
								(0, react_jsx_runtime.jsxs)("section", {
									...
									style: !graphListCollapsed && graphListWidth !== null ? {
										width: graphListWidth,
										minWidth: graphListWidth
									} : void 0,
								...
								!graphListCollapsed && (0, react_jsx_runtime.jsx)("div", {
									...
									"aria-valuemin": 120,
									"aria-valuemax": 900,
									"aria-valuenow": graphListWidth === null ? void 0 : graphListWidth,
									tabIndex: 0,
