window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function FilePane({ file, search, content, truncated, binary, size, loading, canShowDiff, view, onViewChange, syntaxHighlight, blameOn, onToggleBlame, blameState, t }) {
