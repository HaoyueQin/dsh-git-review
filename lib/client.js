window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function splitByMatch(text, search) {
		...
		function rowHasMatch(row, search) {
			if (search === "") return false;
			return row.left !== null && countOccurrences(row.left.text, search) > 0 || row.right !== null && countOccurrences(row.right.text, search) > 0;
		}
		function countMatchRows(parsed, search) {
			if (search === "") return 0;
			let count = 0;
			for (const hunk of parsed.hunks) for (const row of hunk.rows) if (rowHasMatch(row, search)) count += 1;
			return count;
		}
		//#endregion
		...
		var review_module_css_default = {
			...
			"baseArrow": "review-module_baseArrow",
			...
			"commitInfoMeta": "review-module_commitInfoMeta",
			...
			"commitSpacer": "review-module_commitSpacer",
		...
		function ViewSwitch({ active, onViewChange, t }) {
			return (0, react_jsx_runtime.jsx)("span", {
				...
				children: ["diff", "file"].map((candidate) => (0, react_jsx_runtime.jsx)("button", {
					type: "button",
					className: review_module_css_default.scopeBtn + (active === candidate ? " " + review_module_css_default.scopeBtnActive : ""),
					onClick: () => {
						onViewChange(candidate);
					},
					children: t("view." + candidate)
				}, candidate))
			});
		}
		function FilePane({ file, content, truncated, binary, size, loading, canShowDiff, view, onViewChange, t }) {
		...
		function renderCellText(cell, search) {
			if (cell === null) return "";
		...
		function Row({ row, search, matchOrdinal, active, commentTitle, onComment }) {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(0, react_jsx_runtime.jsxs)("span", {
						...
						children: [renderCellText(row.left, search), row.left?.noNewline === true && (0, react_jsx_runtime.jsx)("em", {
					...
					(0, react_jsx_runtime.jsxs)("span", {
						...
						children: [renderCellText(row.right, search), row.right?.noNewline === true && (0, react_jsx_runtime.jsx)("em", {
							className: review_module_css_default.noNewline,
							children: "↩"
						})]
					}),
		...
		function DiffPane({ file, diff, truncated, loading, binary, size, full, onToggleFull, scope, onScopeChange, view, onViewChange, showViewSwitch = true, search, baseActive, useInput, inputActions, t }) {
			...
			const matchRowCount = (0, react.useMemo)(() => countMatchRows(parsed, search), [parsed, search]);
			(0, react.useEffect)(() => {
				setActiveMatch(0);
			}, [search, file.path]);
			(0, react.useEffect)(() => {
		...
		function renderHunks(parsed, ui) {
			...
			parsed.hunks.forEach((hunk, hi) => {
				...
				out.push((0, react_jsx_runtime.jsxs)(react.Fragment, { children: [
					...
					rows.map((row, ri) => {
						const ordinal = rowHasMatch(row, ui.search) ? matchCounter++ : void 0;
			...
			return (0, react_jsx_runtime.jsxs)("svg", {
				...
				children: [
					...
					row.inEdges.map((edge, index) => (0, react_jsx_runtime.jsx)("path", {
						d: "M " + x(edge.from) + " 0 Q " + x(edge.from) + " 13.5 " + x(edge.to) + " 13.5",
						fill: "none",
						stroke: laneColor(edge.color),
						strokeWidth: 1.5
					}, "i" + index)),
					row.outEdges.map((edge, index) => (0, react_jsx_runtime.jsx)("path", {
						d: "M " + x(edge.from) + " 13.5 Q " + x(edge.to) + " 13.5 " + x(edge.to) + " 27",
						fill: "none",
						stroke: laneColor(edge.color),
						strokeWidth: 1.5
					}, "o" + index)),
		...
		function CommitGraph({ commits, lanes, selected, onSelect, t }) {
			return (0, react_jsx_runtime.jsx)("div", {
				...
				children: commits.map((commit, index) => {
					...
					return (0, react_jsx_runtime.jsxs)("button", {
						...
						children: [
							row !== void 0 && (0, react_jsx_runtime.jsx)(GraphCell, { row }),
							(0, react_jsx_runtime.jsx)("span", {
								className: review_module_css_default.commitSubject,
								children: commit.subject
							}),
							commit.refs.map((ref) => (0, react_jsx_runtime.jsx)("span", {
								className: ref.kind === "head" ? review_module_css_default.refBadgeHead : ref.kind === "tag" ? review_module_css_default.refBadgeTag : review_module_css_default.refBadgeOther,
								title: ref.kind === "head" ? t("graph.headRef") : ref.kind === "tag" ? t("graph.tagRef") : ref.name,
								children: ref.name
							}, ref.kind + ":" + ref.name)),
							(0, react_jsx_runtime.jsx)("span", { className: review_module_css_default.commitSpacer }),
							(0, react_jsx_runtime.jsx)("span", {
		...
		function TreePanel({ files, selected, onSelect, filter, onFilterChange, collapsed, onToggleDir, mode, onModeChange, showModeRow = true, listFailed, matchCounts, t }) {
		...
		function ReviewView({ cwd, t, useSession, useInput, inputActions }) {
			...
			const [viewMode, setViewMode] = (0, react.useState)("diff");
			...
			(0, react.useEffect)(() => {
				if (search === "" || cwd === void 0 || !rangeReady || viewTab !== "changes") {
				...
				children: [
					(0, react_jsx_runtime.jsxs)("header", {
						...
						children: [
							...
							!refsMode ? (0, react_jsx_runtime.jsxs)("label", {
								className: review_module_css_default.branchChip,
								title: t("base.label"),
								children: [
									(0, react_jsx_runtime.jsx)(BranchIcon, {}),
									(0, react_jsx_runtime.jsxs)("select", {
										className: review_module_css_default.branchSelect,
										value: baseRef ?? "",
										onChange: (event) => {
											changeBase(event.target.value === "" ? null : event.target.value);
										},
										children: [(0, react_jsx_runtime.jsx)("option", {
											value: "",
											children: data?.branch ?? "HEAD"
										}), (0, react_jsx_runtime.jsx)(RefOptionGroups, {
											refs,
											t
										})]
									}),
									baseRef !== null && (0, react_jsx_runtime.jsx)("span", {
										className: review_module_css_default.baseArrow,
										children: "→"
									})
								]
							}) : (0, react_jsx_runtime.jsxs)("label", {
								className: review_module_css_default.branchChip + " " + review_module_css_default.rangeChip,
							...
							(0, react_jsx_runtime.jsxs)("label", {
								...
								children: [
									...
									viewTab === "changes" && search !== "" && (0, react_jsx_runtime.jsx)("span", {
							...
							(0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									(0, react_jsx_runtime.jsxs)("select", {
										...
										value: branchStart,
										onChange: (event) => {
											setBranchStart(event.target.value);
										},
										children: [(0, react_jsx_runtime.jsx)("option", {
											value: "",
											children: t("branch.fromHead")
										}), (0, react_jsx_runtime.jsx)(RefOptionGroups, {
											refs,
											t
										})]
							...
							children: selectedCommit === null || commitInfo === null ? (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [(0, react_jsx_runtime.jsxs)("div", {
									...
									children: [(0, react_jsx_runtime.jsx)("div", {
										...
										className: review_module_css_default.commitInfoMeta,
										children: [
											(0, react_jsx_runtime.jsx)("span", {
												className: review_module_css_default.commitHash,
												children: commitInfo.hash.slice(0, 7)
											}),
											...
											commitInfo.parents.length > 0 && (0, react_jsx_runtime.jsx)("span", { children: t("graph.parent") + " " + commitInfo.parents[0].slice(0, 7) }),
											commitFiles !== null && (0, react_jsx_runtime.jsx)("span", { children: t("graph.filesCount", { count: commitFiles.length }) })
										]
									})]
								}), (0, react_jsx_runtime.jsxs)("div", {
		...
		function RefOptionGroups({ refs, t }) {
			if (refs === null || refs.length === 0) return null;
			const groups = [
				{
					kind: "branch",
					label: t("ref.branches")
				},
				{
					kind: "remote",
					label: t("ref.remotes")
			...
			return (0, react_jsx_runtime.jsx)(react_jsx_runtime.Fragment, { children: groups.map((group) => {
				const entries = refs.filter((ref) => ref.kind === group.kind);
				if (entries.length === 0) return null;
				return (0, react_jsx_runtime.jsx)("optgroup", {
					label: group.label,
					children: entries.map((ref) => (0, react_jsx_runtime.jsx)("option", {
						value: ref.name,
						children: ref.name
					}, group.kind + ":" + ref.name))
				}, group.kind);
