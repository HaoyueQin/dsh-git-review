window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function prefsEqual(a, b) {
			return a.viewMode === b.viewMode && a.searchScope === b.searchScope && a.graphCollapsed === b.graphCollapsed && a.searchCS === b.searchCS && a.searchRegex === b.searchRegex;
		}
					...
					const sync = () => {
						...
						if (!migrated) {
							...
							if (raw !== null) {
								...
								if (fields !== null && snap.writable && sectionIsDefault(snap.value)) for (const [field, value] of Object.entries(fields)) bound.set(field, value);
