window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function FileMenu({ state, apps, writable, refsMode, useInput, inputActions, onClose, openApp, copyPath, copyName, rename, remove, gitAction, conflictResolve, openInPlugin, t }) {
			...
			const pluginOpener = state.from === "commit" ? openInPlugin : void 0;
			const items = [
				...pluginOpener === void 0 ? [] : [{
					key: "open-in-plugin",
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					fileMenu !== null && (0, react_jsx_runtime.jsx)(FileMenu, {
						...
						t
					}, fileMenu.path + "@" + fileMenu.x + ":" + fileMenu.y),
		...
		function NotRepoView({ cwd, root, t, onDidInit }) {
