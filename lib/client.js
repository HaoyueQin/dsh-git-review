window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function ReviewView({ cwd, t, useSession, useInput, inputActions }) {
			...
			const [viewMode, setViewMode] = (0, react.useState)("split");
			const [searchDraft, setSearchDraft] = (0, react.useState)("");
			const [search, setSearch] = (0, react.useState)("");
			const [searchScope, setSearchScope] = (0, react.useState)("diff");
			const [searchCS, setSearchCS] = (0, react.useState)(false);
			const [searchRegex, setSearchRegex] = (0, react.useState)(false);
			...
			const [graphListCollapsed, setGraphListCollapsed] = (0, react.useState)(false);
