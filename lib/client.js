window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function Row({ row }) {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				className: review_module_css_default.row + " " + kindClass,
				children: [
					(0, react_jsx_runtime.jsx)("span", {
					...
					(0, react_jsx_runtime.jsxs)("span", {
						...
						children: [row.left?.text ?? "", row.left?.noNewline === true && (0, react_jsx_runtime.jsx)("em", {
					...
					(0, react_jsx_runtime.jsxs)("span", {
						...
						children: [row.right?.text ?? "", row.right?.noNewline === true && (0, react_jsx_runtime.jsx)("em", {
							className: review_module_css_default.noNewline,
							children: "↩"
						})]
					})
		...
		function DiffPane({ file, diff, truncated, loading, binary, size, full, onToggleFull, scope, onScopeChange, view, onViewChange, t }) {
		...
		function renderHunks(parsed, ui) {
			...
			parsed.hunks.forEach((hunk, hi) => {
				...
				out.push((0, react_jsx_runtime.jsxs)(react.Fragment, { children: [
					...
					rows.map((row, ri) => (0, react_jsx_runtime.jsx)(Row, { row }, ri))
				] }, hi));
			});
		...
		function FileRow({ entry, depth, selected, onSelect, t }) {
		...
		function Node({ entry, depth, selected, onSelect, collapsed, onToggleDir, t }) {
		...
		function TreePanel({ files, selected, onSelect, filter, onFilterChange, collapsed, onToggleDir, mode, onModeChange, listFailed, t }) {
