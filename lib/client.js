window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var review_module_css_default = {
			...
			"expandFab": "review-module_expandFab",
		...
		function CommitGraph({ commits, lanes, selected, onSelect, density = 4, worktree, worktreeSelected = false, onSelectWorktree, onCommitMenu, t }) {
					...
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							viewTab === "graph" ? (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
								!graphListCollapsed && (0, react_jsx_runtime.jsxs)("section", {
									ref: graphListRef,
									className: review_module_css_default.graphList,
									style: graphListWidth !== null ? {
								...
								(0, react_jsx_runtime.jsxs)("main", {
									...
									children: [graphListCollapsed && (0, react_jsx_runtime.jsx)("button", {
										type: "button",
										className: review_module_css_default.returnFab + " " + review_module_css_default.expandFab,
										title: t("graph.expandList"),
										"aria-label": t("graph.expandList"),
										onClick: expandGraphList,
										children: "▸"
									}), graphWorktree ? (0, react_jsx_runtime.jsxs)("div", {
