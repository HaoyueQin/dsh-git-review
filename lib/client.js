window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function defangRemoteImages(text) {
			...
			REF_USE.lastIndex = 0;
			return inline.replace(REF_USE, (whole, id) => remoteIds.has(id.toUpperCase()) ? whole.slice(1) : whole);
		}
		...
		function Node({ entry, depth, selected, onSelect, collapsed, onToggleDir, matchCounts, viewedHas, onToggleViewed, onFileMenu, onDirMenu, t }) {
			...
			}), !isCollapsed && dir.children.map((child) => (0, react_jsx_runtime.jsx)(Node, {
				entry: child,
				depth: depth + 1,
				selected,
				onSelect,
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(0, react_jsx_runtime.jsx)("div", {
						...
						})] }) : (tree?.children ?? []).map((child) => (0, react_jsx_runtime.jsx)(Node, {
							entry: child,
							depth: 0,
							selected,
							onSelect,
