	...
	factory: (require) => {
		...
		function Row({ row }) {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [(0, react_jsx_runtime.jsx)(Cell, { cell: row.left }), (0, react_jsx_runtime.jsx)(Cell, { cell: row.right })]
			});
		}
		function Cell({ cell }) {
			return (0, react_jsx_runtime.jsxs)("span", {
				className: review_module_css_default.cell,
				children: [(0, react_jsx_runtime.jsx)("span", {
					className: review_module_css_default.cellNo,
					children: cell?.no ?? ""
				}), (0, react_jsx_runtime.jsxs)("span", {
					className: review_module_css_default.cellText + (cell === null ? " " + review_module_css_default.cellHatched : ""),
					children: [cell?.text ?? "", cell?.noNewline === true && (0, react_jsx_runtime.jsx)("em", {
		...
		function DiffPane({ file, diff, truncated, loading, binary, size, full, onToggleFull, t }) {
		...
		async function loadFileDiff(cwd, path, origPath, untracked, full) {
		...
		function ReviewView({ cwd, t }) {
			...
			(0, react.useEffect)(() => {
				...
				loadFileDiff(cwd, selected, selectedFile.origPath, selectedFile.untracked, diffFull).then((next) => {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [(0, react_jsx_runtime.jsxs)("header", {
					...
					children: [data !== null && (0, react_jsx_runtime.jsx)(TreePanel, {
						files: data.files,
						selected,
		...
		const en = {
			...
			"empty.hint": "Pick a changed file on the left",
