window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function CommitGraph({ commits, lanes, selected, onSelect, collapsed = false, worktree, worktreeSelected = false, onSelectWorktree, t }) {
			...
			if (collapsed) return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					worktree !== null && worktree !== void 0 && (0, react_jsx_runtime.jsxs)("div", {
						...
						style: { gridTemplateColumns: "var(--graph-w) minmax(0, 1fr) 56px" },
						children: [
							(0, react_jsx_runtime.jsxs)("svg", {
								className: review_module_css_default.graphCell,
								width: graphWidth,
