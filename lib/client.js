window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function DiffPane({ file, diff, truncated, loading, binary, size, full, onToggleFull, scope, onScopeChange, view, onViewChange, search, baseActive, useInput, inputActions, t }) {
				...
				children: [
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							(0, react_jsx_runtime.jsx)(ViewSwitch, {
								active: view,
								onViewChange,
								t
							}),
		...
		function ReviewView({ cwd, t, useSession, useInput, inputActions }) {
			...
			(0, react.useEffect)(() => {
				if (search === "" || cwd === void 0 || !rangeReady) {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
						...
						children: [
							...
							(0, react_jsx_runtime.jsxs)("label", {
								...
								children: [
									...
									search !== "" && (0, react_jsx_runtime.jsx)("span", {
					...
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [(0, react_jsx_runtime.jsx)("main", {
