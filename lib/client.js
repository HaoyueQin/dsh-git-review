window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function Row({ row, search, matchOrdinal, active }) {
		...
		function DiffPane({ file, diff, truncated, loading, binary, size, full, onToggleFull, scope, onScopeChange, view, onViewChange, search, baseActive, t }) {
